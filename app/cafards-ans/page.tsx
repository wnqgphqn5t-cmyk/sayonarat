...
export const metadata: Metadata = {
  alternates: { canonical: "/cafards-ans" },
  title: "Cafards Ans — Élimination garantie, intervention rapide",
  description:
    "Infestation de cafards à Ans ? Traitement professionnel par gel insecticide ou pulvérisation. Résultat garanti, devis gratuit sous 24h. Techniciens professionnels.",
};
...
const faqs = [
  {
    q: "Comment savoir si j'ai des cafards dans mon logement à Ans ?",
  ...
  {
    q: "Pourquoi les cafards se propagent-ils à Ans ?",
    a: "Les copropriétés de Loncin partagent des gaines techniques et des conduits communs qui facilitent la propagation entre appartements. Un traitement individuel ne suffit souvent pas — Sayonarat peut coordonner une intervention multi-logements.",
  },
  {
    q: "Combien coûte un traitement cafards à Ans ?",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Élimination cafards à Ans",
  provider: {
    "@type": "LocalBusiness",
    name: "Sayonarat",
    telephone: phone,
  ...
  areaServed: "Ans",
  description: "Service professionnel d'élimination de cafards à Ans. Traitement par gel insecticide, résultat garanti.",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Ans", item: "https://www.sayonarat.be/cafards-ans" },
  ],
};

export default function CafardsAnsPage() {
  return (
    <>
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="text-white py-14 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-3xl md:text-4xl font-bold mb-4">
            Cafards à Ans — Élimination garantie | Sayonarat
          </h1>
          <p className="text-green-100 text-lg max-w-2xl mb-6">
            Une infestation de cafards s'étend vite et ne disparaît pas seule.
            Sayonarat vous met en contact avec un technicien professionnel à Ans,
      ...
      <section className="py-14 px-4 max-w-4xl mx-auto">
        <div className="relative rounded-2xl overflow-hidden shadow-lg h-64 md:h-80 mb-10">
          <Image
            ...
            alt={"Traitement cafards à Ans"}
            fill
            className="object-cover"
            priority
          />
          <div className="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent flex items-end p-5">
            <p className="text-white text-sm font-medium">Traitement professionnel cafards — Ans</p>
          </div>
        </div>

        <h2 className="text-2xl font-bold mb-4" style={{ color: "#1B4332" }}>
          Cafards à Ans : pourquoi agir vite ?
        </h2>
        <p className="text-gray-700 mb-6 leading-relaxed">
          Les copropriétés des années 70–90 de Loncin et Montegnée partagent des gaines techniques communes qui facilitent la propagation des cafards entre appartements. Un traitement coordonné entre voisins est souvent nécessaire pour éradiquer définitivement la colonie.
        </p>
        <p className="text-gray-700 mb-6 leading-relaxed">
        ...
        <div className="bg-yellow-50 border-l-4 border-yellow-400 p-5 rounded-r-xl mb-8">
          <p className="font-semibold text-gray-800 mb-3">Tarifs indicatifs — Cafards Ans</p>
      ...
      <section className="py-12 px-4 bg-gray-50">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-2xl font-bold mb-8 text-center" style={{ color: "#1B4332" }}>
            Questions fréquentes — Cafards Ans
          </h2>
      ...
      <section className="py-10 px-4 max-w-4xl mx-auto">
        ...
        <div className="flex flex-wrap gap-3 text-sm">
          {[
            ...
            { label: "Cafards Herstal", href: "/cafards-herstal" },
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="py-14 px-4 text-white text-center">
        <h2 className="text-2xl font-bold mb-3">Cafards à Ans ? Agissez maintenant.</h2>
