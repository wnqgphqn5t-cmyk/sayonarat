...
export const metadata: Metadata = {
  alternates: { canonical: "/guepes-frelons-mons" },
  title: "Guêpes et frelons Mons — Destruction nid rapide",
  description:
    "Nid de guêpes ou frelons à Mons ? Destruction professionnelle sous 48h. Intervention nocturne sécurisée, garantie résultat. Devis gratuit.",
};

const faqs = [
  {
    q: "Combien coûte la destruction d'un nid de guêpes à Mons ?",
  ...
  {
    q: "Les guêpes à Mons : quelles zones sont les plus touchées ?",
    a: "Le centre historique de Mons est très touché dans les combles des maisons bourgeoises et des bâtiments anciens. Ghlin et Cuesmes, avec leurs maisons individuelles et jardins, concentrent de nombreux nids de guêpes germaniques. Le frelon asiatique est présent dans toute la région montoise.",
  },
  {
    q: "Mon voisin a un nid de guêpes à Mons, que faire ?",
  ...
  {
    q: "Le frelon asiatique est-il présent à Mons ?",
    a: "Oui. Le frelon asiatique est désormais établi dans toute la Belgique, y compris à Mons. Son nid, souvent perché à plus de 5 mètres de hauteur dans les arbres, est plus difficile à traiter qu'un nid de guêpes classique. Une intervention professionnelle avec équipement adapté est indispensable.",
  },
];
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Destruction nid guêpes et frelons à Mons",
  provider: {
    "@type": "LocalBusiness",
    name: "Sayonarat",
    telephone: phone,
  ...
  areaServed: "Mons",
  description: "Service de destruction de nids de guêpes et frelons à Mons. Intervention nocturne sécurisée, résultat garanti.",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "Désinsectisation Mons", item: "https://www.sayonarat.be/desinsectisation-mons" },
    { "@type": "ListItem", position: 3, name: "Mons", item: "https://www.sayonarat.be/guepes-frelons-mons" },
  ],
};

export default function GuepesFretonsMonsPage() {
  return (
    <>
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="text-white py-14 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-3xl md:text-4xl font-bold mb-4">
            Guêpes et frelons à Mons — Destruction nid | Sayonarat
          </h1>
          <p className="text-green-100 text-lg max-w-2xl mb-6">
            Nid de guêpes dans vos combles ou jardin à Mons ? Intervention nocturne
      ...
      <section className="py-14 px-4 max-w-4xl mx-auto">
        <div className="relative rounded-2xl overflow-hidden shadow-lg h-64 md:h-72 mb-10">
          <Image src="/nid-guepes.jpg" alt={"Nid de guêpes traité à Mons"} fill className="object-cover" priority />
          <div className="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent flex items-end p-5">
            <p className="text-white text-sm font-medium">Destruction de nid de guêpes — Mons</p>
          </div>
        </div>
        ...
        <h2 className="text-2xl font-bold mb-4" style={{ color: "#1B4332" }}>Nids de guêpes à Mons : une chef-lieu du Hainaut avec son centre historique et ses nombreux jardins. Les toitures en ardoise des maisons bourgeoises, les jardins des quartiers résidentiels de Ghlin et Cuesmes et les parcs de la ville concentrent la plupart des nids signalés chaque été.</h2>
        <p className="text-gray-700 mb-8 leading-relaxed">
          ...
          Ghlin et Cuesmes sont les zones périphériques les plus touchées. Le centre historique de Mons concentre des nids dans les combles des bâtiments anciens. Les parcs et espaces verts hébergent des nids de frelons dans les arbres.
        </p>
      ...
      <section className="py-12 px-4 bg-gray-50">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-2xl font-bold mb-8 text-center" style={{ color: "#1B4332" }}>Questions fréquentes — Guêpes Mons</h2>
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="py-14 px-4 text-white text-center">
        <h2 className="text-2xl font-bold mb-3">Nid de guêpes à Mons ?</h2>
