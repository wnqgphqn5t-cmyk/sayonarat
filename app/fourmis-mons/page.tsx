...
export const metadata: Metadata = {
  ...
  description:
    "Invasion de fourmis à Mons ? Fourmis charpentières, pharaon, des jardins. Traitement par gel transmissible. Devis gratuit sous 24h, garantie de réintervention.",
};

const faqs = [
  {
    q: "Comment identifier l'espèce de fourmis dans mon logement à Mons ?",
  ...
  {
    q: "Les fourmis pharaon sont-elles présentes à Mons ?",
    a: "Les fourmis charpentières sont fréquentes dans les vieilles charpentes des maisons du centre historique de Mons. Les fourmis des jardins colonisent les parcs et jardins de Ghlin et Cuesmes. Les fourmis pharaon sont signalées dans les logements étudiants.",
  },
  {
    q: "Combien coûte un traitement fourmis à Mons ?",
  ...
  },
  {
    ...
    a: "Pour les fourmis des jardins : 1 à 2 semaines après application du gel. Pour les fourmis pharaon : 3 à 6 semaines — les ouvrières rapportent le gel à la reine. Une garantie de réintervention est incluse dans tous nos traitements à Mons.",
  },
];
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Traitement fourmis à Mons",
  provider: {
    "@type": "LocalBusiness",
    name: "Sayonarat",
    telephone: phone,
  ...
  areaServed: "Mons",
  description: "Traitement professionnel contre les fourmis à Mons. Fourmis pharaon, charpentières, des jardins. Gel transmissible, garantie de réintervention.",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Mons", item: "https://www.sayonarat.be/fourmis-mons" },
  ],
};

export default function FourmisMonsPage() {
  return (
    <>
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="text-white py-14 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-3xl md:text-4xl font-bold mb-4">
            Fourmis à Mons — Traitement professionnel garanti
          </h1>
      ...
      <section className="py-10 px-4 max-w-4xl mx-auto">
        <div className="relative rounded-2xl overflow-hidden shadow-lg h-64 mb-10">
          <Image
            ...
            alt={"Traitement fourmis Mons"}
            fill
            className="object-cover"
            priority
          />
          <div className="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent flex items-end p-5">
            <p className="text-white text-sm font-medium">Traitement fourmis par gel professionnel — Mons</p>
          </div>
        </div>

        <h2 className="text-2xl font-bold mb-4" style={{ color: "#1B4332" }}>
          Fourmis à Mons : un problème fréquent
        </h2>
        <p className="text-gray-700 mb-6 leading-relaxed">
          Les jardins des maisons bourgeoises et les pelouses des parcs de Mons, ainsi que les cités résidentielles de Ghlin et Cuesmes, offrent des conditions idéales pour les fourmis des jardins. Les vieilles charpentes du centre historique hébergent souvent des fourmis charpentières.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-10">
          {[
            ...
            { emoji: "✅", t: "Garantie incluse", d: "Si des fourmis réapparaissent pendant la période de garantie, retour sans frais. Inclus dans toutes nos interventions à Mons." },
          ].map((card) => (
        ...
        <div className="bg-yellow-50 border-l-4 border-yellow-400 p-5 rounded-r-xl mb-10">
          <p className="font-semibold text-gray-800 mb-3">Tarifs indicatifs — Fourmis Mons</p>
      ...
      <section className="py-12 px-4 bg-gray-50">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-2xl font-bold mb-8 text-center" style={{ color: "#1B4332" }}>
            Questions fréquentes — Fourmis Mons
          </h2>
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="py-14 px-4 text-white text-center">
        <h2 className="text-2xl font-bold mb-3">Fourmis à Mons ?</h2>
