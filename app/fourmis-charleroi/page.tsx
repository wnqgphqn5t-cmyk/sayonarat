...
export const metadata: Metadata = {
  ...
  description:
    "Invasion de fourmis à Charleroi ? Fourmis charpentières, pharaon, des jardins. Traitement par gel transmissible. Devis gratuit sous 24h, garantie 30 jours.",
};
...
const faqs = [
  ...
  },
  {
    ...
    a: "Pour les fourmis des jardins : 1 à 2 semaines après application du gel. Pour les fourmis pharaon : 3 à 6 semaines — les ouvrières rapportent le gel à la reine. Une garantie 30 jours est incluse dans tous nos traitements à Charleroi.",
  },
];
...
const jsonLd = {
  ...
  description: "Traitement professionnel contre les fourmis à Charleroi. Fourmis pharaon, charpentières, des jardins. Gel transmissible, garantie 30 jours.",
      ...
      <section className="py-10 px-4 max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-10">
          {[
            ...
            { emoji: "✅", t: "Garantie 30 jours", d: "Si des fourmis réapparaissent dans les 30 jours, retour sans frais. Inclus dans toutes nos interventions à Charleroi." },
          ].map((card) => (
