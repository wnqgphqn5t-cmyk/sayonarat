...
const faqs = [
  {
    q: "Comment les punaises de lit arrivent-elles à Mons ?",
    a: "Principalement via les voyages (valises contaminées), les achats de meubles ou matelas d'occasion dans les brocantes et marchés de Mons, et les déménagements depuis des logements infestés. Les hôtels du centre historique de Mons, fréquentés par les visiteurs de la région, peuvent également être des vecteurs de contamination.",
  },
  {
    q: "Combien coûte un traitement punaises de lit à Mons ?",
  ...
  {
    q: "Le traitement thermique fonctionne-t-il dans les maisons anciennes de Mons ?",
    a: "Oui, dans la grande majorité des cas. Les maisons de caractère du vieux Mons ou des quartiers de Jemappes nécessitent parfois une préparation adaptée. Certains objets sensibles à la chaleur doivent être mis de côté avant l'intervention. Le technicien vous communique une liste précise lors du diagnostic.",
  },
  {
    q: "Combien de temps dure le traitement à Mons ?",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Traitement punaises de lit à Mons",
  provider: {
    "@type": "LocalBusiness",
    name: "Sayonarat",
    telephone: phone,
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Mons", item: "https://www.sayonarat.be/punaises-de-lit-mons" },
  ],
};

export default function PunaisesMonsPage() {
  return (
    <>
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="text-white py-14 px-4">
        <div className="max-w-4xl mx-auto">
          <p className="text-green-300 text-sm mb-2">
            ...
            <Link href="/punaises-de-lit-liege" className="hover:text-white">Punaises de lit Liège</Link> › Mons
          </p>
          <h1 className="text-3xl md:text-4xl font-bold mb-4">
            Punaises de lit Mons — Traitement garanti | Sayonarat
          </h1>
          <p className="text-green-100 text-lg max-w-2xl mb-6">
            Punaises de lit à Mons ? Traitement thermique ou chimique dans le centre historique
            et tous les quartiers montois. Résultat garanti dès la première intervention. Devis gratuit sous 24h.
          </p>
      ...
      <section className="py-14 px-4 max-w-4xl mx-auto">
        <div className="relative rounded-2xl overflow-hidden shadow-lg h-64 mb-10">
          <Image src="/chambre-punaises.jpg" alt="Chambre traitée punaises de lit Mons" fill className="object-cover" priority />
          <div className="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent flex items-end p-5">
            <p className="text-white text-sm font-medium">Chambre saine après traitement punaises — Mons</p>
          </div>
        </div>

        <h2 className="text-2xl font-bold mb-6" style={{ color: "#1B4332" }}>Deux méthodes de traitement à Mons</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
          <div className="border-2 border-green-200 rounded-xl p-6">
            ...
            <p className="text-sm text-gray-600 mb-3">Chaleur portée à 60°C+ pendant 6 à 8h. Détruit punaises et œufs en une seule session, sans produit chimique résiduel. Efficace dans les maisons de caractère du vieux Mons comme dans les appartements modernes.</p>
        ...
        <div className="bg-yellow-50 border-l-4 border-yellow-400 p-5 rounded-r-xl mb-10">
          ...
          <p className="text-sm text-gray-700 mt-1">
            Toutes nos interventions à Mons sont couvertes par une garantie de réintervention.
      ...
      <section className="py-12 px-4 bg-gray-50">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-2xl font-bold mb-8 text-center" style={{ color: "#1B4332" }}>Questions fréquentes — Punaises de lit Mons</h2>
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="py-14 px-4 text-white text-center">
        <h2 className="text-2xl font-bold mb-3">Punaises de lit à Mons ?</h2>
