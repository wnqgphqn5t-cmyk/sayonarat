...
const faqs = [
  {
    q: "Comment les punaises de lit arrivent-elles à Namur ?",
    a: "Principalement via les voyages (valises contaminées), les achats de meubles ou matelas d'occasion dans les brocantes namuroises, et les déménagements depuis des logements infestés. Les hôtels et hébergements touristiques proches de la citadelle sont également des vecteurs de contamination possibles.",
  },
  {
  ...
  },
  {
    ...
    a: "Dans la grande majorité des cas, oui. Dans les maisons de caractère du vieux Namur ou de Jambes, certains objets sensibles à la chaleur doivent être retirés avant l'intervention. Le technicien vous fournit une liste précise lors du diagnostic préalable.",
  },
  {
    q: "Combien de temps dure le traitement à Namur ?",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Traitement punaises de lit à Namur",
  provider: {
    "@type": "LocalBusiness",
    name: "Sayonarat",
    telephone: phone,
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Namur", item: "https://www.sayonarat.be/punaises-de-lit-namur" },
  ],
};

export default function PunaisesNamurPage() {
  return (
    <>
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="text-white py-14 px-4">
        <div className="max-w-4xl mx-auto">
          <p className="text-green-300 text-sm mb-2">
            ...
            <Link href="/punaises-de-lit-liege" className="hover:text-white">Punaises de lit Liège</Link> › Namur
          </p>
          <h1 className="text-3xl md:text-4xl font-bold mb-4">
            Punaises de lit Namur — Traitement garanti | Sayonarat
          </h1>
          <p className="text-green-100 text-lg max-w-2xl mb-6">
            Punaises de lit à Namur ? Traitement thermique ou chimique,
      ...
      <section className="py-14 px-4 max-w-4xl mx-auto">
        <div className="relative rounded-2xl overflow-hidden shadow-lg h-64 mb-10">
          <Image src="/chambre-punaises.jpg" alt="Chambre traitée punaises de lit Namur" fill className="object-cover" priority />
          <div className="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent flex items-end p-5">
            <p className="text-white text-sm font-medium">Chambre saine après traitement punaises — Namur</p>
          </div>
        </div>
        ...
        <div className="bg-yellow-50 border-l-4 border-yellow-400 p-5 rounded-r-xl mb-10">
          ...
          <p className="text-sm text-gray-700 mt-1">
            Toutes nos interventions à Namur sont couvertes par une garantie de réintervention.
      ...
      <section className="py-12 px-4 bg-gray-50">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-2xl font-bold mb-8 text-center" style={{ color: "#1B4332" }}>Questions fréquentes — Punaises de lit Namur</h2>
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="py-14 px-4 text-white text-center">
        <h2 className="text-2xl font-bold mb-3">Punaises de lit à Namur ?</h2>
