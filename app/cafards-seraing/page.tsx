...
export const metadata: Metadata = {
  alternates: { canonical: "/cafards-seraing" },
  title: "Cafards Seraing — Élimination garantie, intervention rapide",
  description:
    "Infestation de cafards à Seraing ? Traitement professionnel par gel insecticide ou pulvérisation. Résultat garanti, devis gratuit sous 24h. Techniciens professionnels.",
};
...
const faqs = [
  {
    q: "Comment savoir si j'ai des cafards dans mon logement à Seraing ?",
  ...
  {
    q: "Pourquoi les cafards se propagent-ils à Seraing ?",
    a: "Les immeubles ouvriers anciens de Seraing, notamment à Ougrée et Jemeppe, ont souvent des gaines et des caves centenaires qui facilitent la propagation des blattes sur plusieurs logements en même temps. Sayonarat peut coordonner des interventions multi-immeubles avec les régies communales.",
  },
  {
    q: "Combien coûte un traitement cafards à Seraing ?",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Élimination cafards à Seraing",
  provider: {
    "@type": "LocalBusiness",
    name: "Sayonarat",
    telephone: phone,
  ...
  areaServed: "Seraing",
  description: "Service professionnel d'élimination de cafards à Seraing. Traitement par gel insecticide, résultat garanti.",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Seraing", item: "https://www.sayonarat.be/cafards-seraing" },
  ],
};

export default function CafardsSeraingPage() {
  return (
    <>
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="text-white py-14 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-3xl md:text-4xl font-bold mb-4">
            Cafards à Seraing — Élimination garantie | Sayonarat
          </h1>
          <p className="text-green-100 text-lg max-w-2xl mb-6">
            Une infestation de cafards s'étend vite et ne disparaît pas seule.
            Sayonarat vous met en contact avec un technicien professionnel à Seraing,
      ...
      <section className="py-14 px-4 max-w-4xl mx-auto">
        <div className="relative rounded-2xl overflow-hidden shadow-lg h-64 md:h-80 mb-10">
          <Image
            ...
            alt={"Traitement cafards à Seraing"}
            fill
            className="object-cover"
            priority
          />
          <div className="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent flex items-end p-5">
            <p className="text-white text-sm font-medium">Traitement professionnel cafards — Seraing</p>
          </div>
        </div>

        <h2 className="text-2xl font-bold mb-4" style={{ color: "#1B4332" }}>
          Cafards à Seraing : pourquoi agir vite ?
        </h2>
        <p className="text-gray-700 mb-6 leading-relaxed">
          Seraing présente l'une des concentrations les plus élevées d'immeubles ouvriers anciens de la région liégeoise. Les cités d'Ougrée et de Jemeppe-sur-Meuse, avec leurs bâtiments parfois centenaires et leurs gaines dégradées, offrent un habitat idéal aux cafards. La coordination entre voisins est souvent indispensable.
        </p>
        <p className="text-gray-700 mb-6 leading-relaxed">
        ...
        <div className="bg-yellow-50 border-l-4 border-yellow-400 p-5 rounded-r-xl mb-8">
          <p className="font-semibold text-gray-800 mb-3">Tarifs indicatifs — Cafards Seraing</p>
      ...
      <section className="py-12 px-4 bg-gray-50">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-2xl font-bold mb-8 text-center" style={{ color: "#1B4332" }}>
            Questions fréquentes — Cafards Seraing
          </h2>
      ...
      <section className="py-10 px-4 max-w-4xl mx-auto">
        ...
        <div className="flex flex-wrap gap-3 text-sm">
          {[
            ...
            { label: "Cafards Flémalle", href: "/cafards-flemalle" },
            { label: "Cafards Grâce-Hollogne", href: "/cafards-grace-hollogne" }
          ].map((l) => (
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="py-14 px-4 text-white text-center">
        <h2 className="text-2xl font-bold mb-3">Cafards à Seraing ? Agissez maintenant.</h2>
