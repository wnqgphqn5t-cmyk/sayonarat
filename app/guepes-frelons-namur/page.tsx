...
export const metadata: Metadata = {
  alternates: { canonical: "/guepes-frelons-namur" },
  title: "Guêpes et frelons Namur — Destruction nid rapide",
  description:
    "Nid de guêpes ou frelons à Namur ? Destruction professionnelle sous 48h. Intervention nocturne sécurisée, garantie résultat. Devis gratuit.",
};

const faqs = [
  {
    q: "Combien coûte la destruction d'un nid de guêpes à Namur ?",
  ...
  {
    q: "Les guêpes à Namur : quelles zones sont les plus touchées ?",
    a: "Les jardins en terrasse de Jambes et Wépion sont très exposés aux nids dans les haies et les combles des maisons. Wépion, avec ses nombreuses propriétés arborées, est régulièrement touché par le frelon asiatique entre juillet et septembre.",
  },
  {
    q: "Mon voisin a un nid de guêpes à Namur, que faire ?",
  ...
  {
    q: "Le frelon asiatique est-il présent à Namur ?",
    a: "Oui. Le frelon asiatique est désormais établi dans toute la Belgique, y compris à Namur. Son nid, souvent perché à plus de 5 mètres de hauteur dans les arbres, est plus difficile à traiter qu'un nid de guêpes classique. Une intervention professionnelle avec équipement adapté est indispensable.",
  },
];
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Destruction nid guêpes et frelons à Namur",
  provider: {
    "@type": "LocalBusiness",
    name: "Sayonarat",
    telephone: phone,
  ...
  areaServed: "Namur",
  description: "Service de destruction de nids de guêpes et frelons à Namur. Intervention nocturne sécurisée, résultat garanti.",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "Désinsectisation Namur", item: "https://www.sayonarat.be/desinsectisation-namur" },
    { "@type": "ListItem", position: 3, name: "Namur", item: "https://www.sayonarat.be/guepes-frelons-namur" },
  ],
};

export default function GuepesFretonsNamurPage() {
  return (
    <>
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="text-white py-14 px-4">
        <div className="max-w-4xl mx-auto">
          <p className="text-green-300 text-sm mb-2">
            ...
            <Link href="/desinsectisation-namur" className="hover:text-white">Désinsectisation Namur</Link> ›{" "}
            Namur
          </p>
          <h1 className="text-3xl md:text-4xl font-bold mb-4">
            Guêpes et frelons à Namur — Destruction nid | Sayonarat
          </h1>
          <p className="text-green-100 text-lg max-w-2xl mb-6">
            Nid de guêpes dans vos combles ou jardin à Namur ? Intervention nocturne
      ...
      <section className="py-14 px-4 max-w-4xl mx-auto">
        <div className="relative rounded-2xl overflow-hidden shadow-lg h-64 md:h-72 mb-10">
          <Image src="/nid-guepes.jpg" alt={"Nid de guêpes traité à Namur"} fill className="object-cover" priority />
          <div className="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent flex items-end p-5">
            <p className="text-white text-sm font-medium">Destruction de nid de guêpes — Namur</p>
          </div>
        </div>
        ...
        <h2 className="text-2xl font-bold mb-4" style={{ color: "#1B4332" }}>Nids de guêpes à Namur : une capitale de la Wallonie avec ses espaces verts et ses jardins en bord de Meuse. Les jardins en terrasse de Jambes et Wépion, les espaces verts du long de la Meuse et les parcs autour de la citadelle concentrent de nombreux nids de guêpes et de frelons.</h2>
        <p className="text-gray-700 mb-8 leading-relaxed">
          ...
          Jambes et Wépion, avec leurs jardins en terrasse et leurs espaces verts en bord de Meuse, sont les zones les plus touchées. Les parcs autour de la citadelle de Namur hébergent également des nids de frelons dans les arbres.
        </p>
      ...
      <section className="py-12 px-4 bg-gray-50">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-2xl font-bold mb-8 text-center" style={{ color: "#1B4332" }}>Questions fréquentes — Guêpes Namur</h2>
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="py-14 px-4 text-white text-center">
        <h2 className="text-2xl font-bold mb-3">Nid de guêpes à Namur ?</h2>
