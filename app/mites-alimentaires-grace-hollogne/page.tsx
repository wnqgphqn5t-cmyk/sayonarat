...
export const metadata: Metadata = {
  alternates: { canonical: "/mites-alimentaires-grace-hollogne" },
  title: "Mites alimentaires Grâce-Hollogne — Traitement professionnel",
  description:
    "Mites alimentaires à Grâce-Hollogne ? Traitement professionnel contre les mites des denrées. Intervention sous 48h, devis gratuit. Garantie de réintervention.",
};

const jsonLd = {
  "@context": "https://schema.org",
  "@type": "Service",
  name: "Traitement mites alimentaires à Grâce-Hollogne",
  provider: {
    "@type": "LocalBusiness",
    name: "Sayonarat",
    telephone: phone,
  ...
  description: "Service de traitement contre les mites alimentaires à Grâce-Hollogne. Intervention rapide, produits homologués.",
  serviceType: "PestControl",
};

const faqs = [
  {
    q: "Comment savoir si j'ai des mites alimentaires à Grâce-Hollogne ?",
  ...
  {
    q: "Comment les mites alimentaires arrivent-elles dans un logement à Grâce-Hollogne ?",
    a: "Principalement via des produits secs mal conservés ou achetés avec des emballages endommagés. Les grands garde-manger des maisons pavillonnaires de Grâce-Hollogne, avec leurs nombreux stocks peu vérifiés, sont les zones à risque prioritaires.",
  },
  {
  ...
  {
    q: "Combien coûte un traitement mites alimentaires à Grâce-Hollogne ?",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Grâce-Hollogne", item: "https://www.sayonarat.be/mites-alimentaires-grace-hollogne" },
  ],
};

export default function MitesAlimentairesGraceHollognePage() {
  return (
    <>
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="text-white py-14 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-3xl md:text-4xl font-bold mb-4">
            Mites alimentaires à Grâce-Hollogne — Traitement professionnel
          </h1>
          <p className="text-green-100 text-lg max-w-2xl mb-6">
            Larves dans la farine, papillons dans les placards ? Sayonarat intervient pour
            éliminer les mites des denrées à Grâce-Hollogne. Devis gratuit sous 24h.
          </p>
      ...
      <section className="py-14 px-4 max-w-4xl mx-auto">
        <h2 className="text-2xl font-bold mb-4" style={{ color: "#1B4332" }}>
          Mites alimentaires à Grâce-Hollogne
        </h2>
        <p className="text-gray-700 mb-4 leading-relaxed">
          Les maisons pavillonnaires de Grâce-Hollogne avec leurs grandes cuisines et réserves alimentaires bien garnies sont régulièrement touchées par les mites des denrées. Hollogne-aux-Pierres et Bierset comptent chaque été de nombreux signalements.
        </p>
        ...
        <div className="p-6 rounded-2xl text-white text-center" style={{ backgroundColor: "#1B4332" }}>
          <h2 className="text-xl font-bold mb-2">Des mites alimentaires à Grâce-Hollogne ?</h2>
        ...
        <div className="mt-10 pt-6 border-t border-gray-100">
          ...
          <div className="flex flex-wrap gap-3 text-sm">
            ...
            <Link href="/mites-alimentaires-ans" className="underline" style={{ color: "#1B4332" }}>Mites alimentaires Ans</Link>
            <Link href="/mites-alimentaires-awans" className="underline" style={{ color: "#1B4332" }}>Mites alimentaires Awans</Link>
            <Link href="/mites-alimentaires-flemalle" className="underline" style={{ color: "#1B4332" }}>Mites alimentaires Flémalle</Link>
          </div>
        </div>
      </section>

      <section style={{ backgroundColor: "#1B4332" }} className="py-14 px-4 text-white text-center">
        <h2 className="text-2xl font-bold mb-3">Mites alimentaires à Grâce-Hollogne ?</h2>
