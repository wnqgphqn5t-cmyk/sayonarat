...
export const metadata: Metadata = {
  ...
  description:
    "Mites alimentaires à Saint-Nicolas ? Traitement professionnel contre les mites des denrées. Intervention sous 48h, devis gratuit. Garantie de réintervention.",
};

const jsonLd = {
  "@context": "https://schema.org",
  "@type": "Service",
  name: "Traitement mites alimentaires à Saint-Nicolas",
  provider: {
    "@type": "LocalBusiness",
    name: "Sayonarat",
    telephone: phone,
  ...
  description: "Service de traitement contre les mites alimentaires à Saint-Nicolas. Intervention rapide, produits homologués.",
  serviceType: "PestControl",
};

const faqs = [
  {
    q: "Comment savoir si j'ai des mites alimentaires à Saint-Nicolas ?",
  ...
  {
    q: "Comment les mites alimentaires arrivent-elles dans un logement à Saint-Nicolas ?",
    a: "Via des produits alimentaires secs achetés dans les commerces de proximité de Saint-Nicolas ou les marchés de Liège. Les appartements avec peu de rotation des stocks et des placards mal hermétisés sont les plus exposés.",
  },
  {
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Saint-Nicolas", item: "https://www.sayonarat.be/mites-alimentaires-saint-nicolas" },
  ],
};

export default function MitesAlimentairesSaintNicolasPage() {
  return (
    <>
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="text-white py-14 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-3xl md:text-4xl font-bold mb-4">
            Mites alimentaires à Saint-Nicolas — Traitement professionnel
          </h1>
          <p className="text-green-100 text-lg max-w-2xl mb-6">
            Larves dans la farine, papillons dans les placards ? Sayonarat intervient pour
            éliminer les mites des denrées à Saint-Nicolas. Devis gratuit sous 24h.
          </p>
      ...
      <section className="py-14 px-4 max-w-4xl mx-auto">
        <h2 className="text-2xl font-bold mb-4" style={{ color: "#1B4332" }}>
          Mites alimentaires à Saint-Nicolas
        </h2>
        <p className="text-gray-700 mb-4 leading-relaxed">
          Les appartements des immeubles de Tilleur et les logements familiaux de Fragnée et Montegnée sont régulièrement signalés pour des infestations de mites alimentaires. La proximité de Liège et ses marchés favorise l'introduction de produits parfois contaminés.
        </p>
        ...
        <div className="p-6 rounded-2xl text-white text-center" style={{ backgroundColor: "#1B4332" }}>
          <h2 className="text-xl font-bold mb-2">Des mites alimentaires à Saint-Nicolas ?</h2>
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="py-14 px-4 text-white text-center">
        <h2 className="text-2xl font-bold mb-3">Mites alimentaires à Saint-Nicolas ?</h2>
