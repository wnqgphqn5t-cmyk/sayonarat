...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Saint-Nicolas", item: "https://www.sayonarat.be/deratisation-saint-nicolas" },
  ],
};
    ...
    <>
      ...
      <section className="py-14 px-4 max-w-4xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <a href="tel:+32472487954" style={{ backgroundColor: "#FBBF24", color: "#14532d" }}
            className="font-bold px-8 py-3 rounded-lg hover:opacity-90 transition-opacity text-center">
            Appeler maintenant
          </a>
        </div>
