...
export const metadata: Metadata = {
  alternates: { canonical: "/fourmis-grace-hollogne" },
  title: "Fourmis Grâce-Hollogne — Traitement professionnel garanti",
  description:
    "Invasion de fourmis à Grâce-Hollogne ? Fourmis charpentières, pharaon, des jardins. Traitement par gel transmissible. Devis gratuit sous 24h, garantie de réintervention.",
};

const faqs = [
  {
    q: "Comment identifier l'espèce de fourmis dans mon logement à Grâce-Hollogne ?",
  ...
  {
    q: "Les fourmis pharaon sont-elles présentes à Grâce-Hollogne ?",
    a: "Les fourmis des jardins colonisent facilement les jardins contigus des pavillons de Grâce-Hollogne. Les fourmis pharaon sont présentes dans les immeubles collectifs de Grace. La fourmi pavée est également fréquente sous les dalles et les allées.",
  },
  {
    q: "Combien coûte un traitement fourmis à Grâce-Hollogne ?",
  ...
  },
  {
    ...
    a: "Pour les fourmis des jardins : 1 à 2 semaines après application du gel. Pour les fourmis pharaon : 3 à 6 semaines — les ouvrières rapportent le gel à la reine. Une garantie de réintervention est incluse dans tous nos traitements à Grâce-Hollogne.",
  },
];
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Traitement fourmis à Grâce-Hollogne",
  provider: {
    "@type": "LocalBusiness",
    name: "Sayonarat",
    telephone: phone,
  ...
  description: "Traitement professionnel contre les fourmis à Grâce-Hollogne. Fourmis pharaon, charpentières, des jardins. Gel transmissible, garantie de réintervention.",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Grâce-Hollogne", item: "https://www.sayonarat.be/fourmis-grace-hollogne" },
  ],
};

export default function FourmisGraceHollognePage() {
  return (
    <>
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="text-white py-14 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-3xl md:text-4xl font-bold mb-4">
            Fourmis à Grâce-Hollogne — Traitement professionnel garanti
          </h1>
      ...
      <section className="py-10 px-4 max-w-4xl mx-auto">
        <div className="relative rounded-2xl overflow-hidden shadow-lg h-64 mb-10">
          <Image
            ...
            alt={"Traitement fourmis Grâce-Hollogne"}
            fill
            className="object-cover"
            priority
          />
          <div className="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent flex items-end p-5">
            <p className="text-white text-sm font-medium">Traitement fourmis par gel professionnel — Grâce-Hollogne</p>
          </div>
        </div>

        <h2 className="text-2xl font-bold mb-4" style={{ color: "#1B4332" }}>
          Fourmis à Grâce-Hollogne : un problème fréquent
        </h2>
        <p className="text-gray-700 mb-6 leading-relaxed">
          Les lotissements pavillonnaires de Grace et Hollogne-aux-Pierres, avec leurs nombreux jardins contigus, favorisent la propagation des fourmis des jardins entre propriétés voisines. La commune est également concernée par les fourmis pharaon dans les immeubles collectifs.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-10">
          {[
            ...
            { emoji: "✅", t: "Garantie incluse", d: "Si des fourmis réapparaissent pendant la période de garantie, retour sans frais. Inclus dans toutes nos interventions à Grâce-Hollogne." },
          ].map((card) => (
        ...
        <div className="bg-yellow-50 border-l-4 border-yellow-400 p-5 rounded-r-xl mb-10">
          <p className="font-semibold text-gray-800 mb-3">Tarifs indicatifs — Fourmis Grâce-Hollogne</p>
      ...
      <section className="py-12 px-4 bg-gray-50">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-2xl font-bold mb-8 text-center" style={{ color: "#1B4332" }}>
            Questions fréquentes — Fourmis Grâce-Hollogne
          </h2>
      ...
      <section className="py-10 px-4 max-w-4xl mx-auto">
        ...
        <div className="flex flex-wrap gap-3 text-sm">
          {[
            ...
            { label: "Fourmis Ans", href: "/fourmis-ans" },
            { label: "Fourmis Awans", href: "/fourmis-awans" },
            { label: "Fourmis Flémalle", href: "/fourmis-flemalle" }
          ].map((l) => (
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="py-14 px-4 text-white text-center">
        <h2 className="text-2xl font-bold mb-3">Fourmis à Grâce-Hollogne ?</h2>
