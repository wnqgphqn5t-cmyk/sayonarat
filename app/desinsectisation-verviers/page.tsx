...
export const metadata: Metadata = {
  ...
  description:
    "Désinsectisation professionnelle à Verviers. Cafards, fourmis, guêpes. Vallée de la Vesdre, anciens bâtiments textiles couverts. Devis gratuit sous 24h, garantie de réintervention.",
};
...
const jsonLd = {
  ...
  areaServed: "Verviers",
  description: "Désinsectisation professionnelle à Verviers. Cafards, fourmis, guêpes dans la vallée de la Vesdre et les anciens bâtiments textiles. Produits homologués, garantie de réintervention.",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Verviers", item: "https://www.sayonarat.be/desinsectisation-verviers" },
  ],
};
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="text-white py-14 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-green-100 text-lg max-w-2xl mb-6">
            ...
            et tous les quartiers verviétois. Produits homologués, garantie de réintervention.
          </p>
