...
export const metadata: Metadata = {
  alternates: { canonical: "/guepes-frelons-awans" },
  title: "Guêpes et frelons Awans — Destruction nid rapide",
  description:
    "Nid de guêpes ou frelons à Awans ? Destruction professionnelle sous 48h. Intervention nocturne sécurisée, garantie résultat. Devis gratuit.",
};

const faqs = [
  {
    q: "Combien coûte la destruction d'un nid de guêpes à Awans ?",
  ...
  {
    q: "Les guêpes à Awans : quelles zones sont les plus touchées ?",
    a: "Les zones rurales d'Othée et Villers-l'Évêque sont particulièrement concernées : remises agricoles, combles des maisons de campagne, haies vives et vergers constituent des zones idéales pour l'installation de nids entre juin et septembre.",
  },
  {
    q: "Mon voisin a un nid de guêpes à Awans, que faire ?",
  ...
  {
    q: "Le frelon asiatique est-il présent à Awans ?",
    a: "Oui. Le frelon asiatique est désormais établi dans toute la Belgique, y compris à Awans. Son nid, souvent perché à plus de 5 mètres de hauteur dans les arbres, est plus difficile à traiter qu'un nid de guêpes classique. Une intervention professionnelle avec équipement adapté est indispensable.",
  },
];
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Destruction nid guêpes et frelons à Awans",
  provider: {
    "@type": "LocalBusiness",
    name: "Sayonarat",
    telephone: phone,
    address: { "@type": "PostalAddress", addressLocality: "Awans", postalCode: "4340", addressCountry: "BE" },
  },
  areaServed: "Awans",
  description: "Service de destruction de nids de guêpes et frelons à Awans. Intervention nocturne sécurisée, résultat garanti.",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "Désinsectisation Awans", item: "https://www.sayonarat.be/desinsectisation-awans" },
    { "@type": "ListItem", position: 3, name: "Awans", item: "https://www.sayonarat.be/guepes-frelons-awans" },
  ],
};

export default function GuepesFretonsAwansPage() {
  return (
    <>
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="text-white py-14 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-3xl md:text-4xl font-bold mb-4">
            Guêpes et frelons à Awans — Destruction nid | Sayonarat
          </h1>
          <p className="text-green-100 text-lg max-w-2xl mb-6">
            Nid de guêpes dans vos combles ou jardin à Awans ? Intervention nocturne
      ...
      <section className="py-14 px-4 max-w-4xl mx-auto">
        <div className="relative rounded-2xl overflow-hidden shadow-lg h-64 md:h-72 mb-10">
          <Image src="/nid-guepes.jpg" alt={"Nid de guêpes traité à Awans"} fill className="object-cover" priority />
          <div className="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent flex items-end p-5">
            <p className="text-white text-sm font-medium">Destruction de nid de guêpes — Awans</p>
          </div>
        </div>
        ...
        <h2 className="text-2xl font-bold mb-4" style={{ color: "#1B4332" }}>Nids de guêpes à Awans : une commune semi-rurale entre Liège et Waremme avec ses maisons de campagne et ses fermes rénovées. Les zones rurales d'Othée et Villers-l'Évêque sont propices aux nids dans les combles, les remises agricoles et les haies champêtres.</h2>
        <p className="text-gray-700 mb-8 leading-relaxed">
          ...
          Othée, Fooz et Villers-l'Évêque sont les secteurs les plus touchés, notamment les combles des maisons de campagne, les remises agricoles et les haies champêtres.
        </p>
      ...
      <section className="py-12 px-4 bg-gray-50">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-2xl font-bold mb-8 text-center" style={{ color: "#1B4332" }}>Questions fréquentes — Guêpes Awans</h2>
      ...
      <section className="py-10 px-4 max-w-4xl mx-auto">
        ...
        <div className="flex flex-wrap gap-3 text-sm">
          {[
            ...
            { label: "Guêpes et frelons Grâce-Hollogne", href: "/guepes-frelons-grace-hollogne" }
          ].map((l) => (
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="py-14 px-4 text-white text-center">
        <h2 className="text-2xl font-bold mb-3">Nid de guêpes à Awans ?</h2>
