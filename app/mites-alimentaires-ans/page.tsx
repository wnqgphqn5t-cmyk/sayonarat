...
export const metadata: Metadata = {
  alternates: { canonical: "/mites-alimentaires-ans" },
  title: "Mites alimentaires Ans — Traitement professionnel",
  description:
    "Mites alimentaires à Ans ? Traitement professionnel contre les mites des denrées. Intervention sous 48h, devis gratuit. Garantie de réintervention.",
};

const jsonLd = {
  "@context": "https://schema.org",
  "@type": "Service",
  name: "Traitement mites alimentaires à Ans",
  provider: {
    "@type": "LocalBusiness",
    name: "Sayonarat",
    telephone: phone,
  ...
  areaServed: "Ans",
  description: "Service de traitement contre les mites alimentaires à Ans. Intervention rapide, produits homologués.",
  serviceType: "PestControl",
};

const faqs = [
  {
    q: "Comment savoir si j'ai des mites alimentaires à Ans ?",
  ...
  {
    q: "Comment les mites alimentaires arrivent-elles dans un logement à Ans ?",
    a: "Le plus souvent via un produit sec acheté en grande surface déjà contaminé. Les maisons familiales d'Ans avec leurs grandes réserves alimentaires en cave ou garde-manger sont particulièrement vulnérables — une seule femelle suffit à lancer une infestation.",
  },
  {
  ...
  {
    q: "Combien coûte un traitement mites alimentaires à Ans ?",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Ans", item: "https://www.sayonarat.be/mites-alimentaires-ans" },
  ],
};

export default function MitesAlimentairesAnsPage() {
  return (
    <>
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="text-white py-14 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-3xl md:text-4xl font-bold mb-4">
            Mites alimentaires à Ans — Traitement professionnel
          </h1>
          <p className="text-green-100 text-lg max-w-2xl mb-6">
            Larves dans la farine, papillons dans les placards ? Sayonarat intervient pour
            éliminer les mites des denrées à Ans. Devis gratuit sous 24h.
          </p>
      ...
      <section className="py-14 px-4 max-w-4xl mx-auto">
        <h2 className="text-2xl font-bold mb-4" style={{ color: "#1B4332" }}>
          Mites alimentaires à Ans
        </h2>
        <p className="text-gray-700 mb-4 leading-relaxed">
          Les maisons familiales de Loncin et Alleur, avec leurs grands garde-manger et réserves alimentaires, sont particulièrement exposées aux mites des denrées. Les placards à provisions et les caves à provisions sont les zones à risque prioritaires.
        </p>
        ...
        <div className="p-6 rounded-2xl text-white text-center" style={{ backgroundColor: "#1B4332" }}>
          <h2 className="text-xl font-bold mb-2">Des mites alimentaires à Ans ?</h2>
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="py-14 px-4 text-white text-center">
        <h2 className="text-2xl font-bold mb-3">Mites alimentaires à Ans ?</h2>
