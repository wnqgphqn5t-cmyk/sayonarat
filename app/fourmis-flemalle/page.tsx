...
export const metadata: Metadata = {
  alternates: { canonical: "/fourmis-flemalle" },
  title: "Fourmis Flémalle — Traitement professionnel garanti",
  description:
    "Invasion de fourmis à Flémalle ? Fourmis charpentières, pharaon, des jardins. Traitement par gel transmissible. Devis gratuit sous 24h, garantie de réintervention.",
};

const faqs = [
  {
    q: "Comment identifier l'espèce de fourmis dans mon logement à Flémalle ?",
  ...
  {
    q: "Les fourmis pharaon sont-elles présentes à Flémalle ?",
    a: "Les jardins en bord de Meuse de Flémalle-Grande hébergent de nombreuses colonies de fourmis des jardins. Les fourmis charpentières sont fréquentes dans les vieilles charpentes en bois humide. Les fourmis pharaon sont moins fréquentes mais présentes dans les logements collectifs.",
  },
  {
    q: "Combien coûte un traitement fourmis à Flémalle ?",
  ...
  },
  {
    ...
    a: "Pour les fourmis des jardins : 1 à 2 semaines après application du gel. Pour les fourmis pharaon : 3 à 6 semaines — les ouvrières rapportent le gel à la reine. Une garantie de réintervention est incluse dans tous nos traitements à Flémalle.",
  },
];
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Traitement fourmis à Flémalle",
  provider: {
    "@type": "LocalBusiness",
    name: "Sayonarat",
    telephone: phone,
  ...
  areaServed: "Flémalle",
  description: "Traitement professionnel contre les fourmis à Flémalle. Fourmis pharaon, charpentières, des jardins. Gel transmissible, garantie de réintervention.",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "Désinsectisation Flémalle", item: "https://www.sayonarat.be/desinsectisation-flemalle" },
    { "@type": "ListItem", position: 3, name: "Flémalle", item: "https://www.sayonarat.be/fourmis-flemalle" },
  ],
};

export default function FourmisFlemallePage() {
  return (
    <>
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="text-white py-14 px-4">
        <div className="max-w-4xl mx-auto">
          <p className="text-green-300 text-sm mb-2">
            ...
            <Link href="/desinsectisation-flemalle" className="hover:text-white">Désinsectisation Flémalle</Link> ›{" "}
            Flémalle
          </p>
          <h1 className="text-3xl md:text-4xl font-bold mb-4">
            Fourmis à Flémalle — Traitement professionnel garanti
          </h1>
      ...
      <section className="py-10 px-4 max-w-4xl mx-auto">
        <div className="relative rounded-2xl overflow-hidden shadow-lg h-64 mb-10">
          <Image
            ...
            alt={"Traitement fourmis Flémalle"}
            fill
            className="object-cover"
            priority
          />
          <div className="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent flex items-end p-5">
            <p className="text-white text-sm font-medium">Traitement fourmis par gel professionnel — Flémalle</p>
          </div>
        </div>

        <h2 className="text-2xl font-bold mb-4" style={{ color: "#1B4332" }}>
          Fourmis à Flémalle : un problème fréquent
        </h2>
        <p className="text-gray-700 mb-6 leading-relaxed">
          Les jardins des maisons ouvrières de Flémalle-Grande et les espaces verts en bord de Meuse hébergent de nombreuses colonies de fourmis des jardins. La présence de bois et de végétation dense favorise également les fourmis charpentières dans les vieilles charpentes.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-10">
          {[
            ...
            { emoji: "✅", t: "Garantie incluse", d: "Si des fourmis réapparaissent pendant la période de garantie, retour sans frais. Inclus dans toutes nos interventions à Flémalle." },
          ].map((card) => (
        ...
        <div className="bg-yellow-50 border-l-4 border-yellow-400 p-5 rounded-r-xl mb-10">
          <p className="font-semibold text-gray-800 mb-3">Tarifs indicatifs — Fourmis Flémalle</p>
      ...
      <section className="py-12 px-4 bg-gray-50">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-2xl font-bold mb-8 text-center" style={{ color: "#1B4332" }}>
            Questions fréquentes — Fourmis Flémalle
          </h2>
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="py-14 px-4 text-white text-center">
        <h2 className="text-2xl font-bold mb-3">Fourmis à Flémalle ?</h2>
