...
export const metadata: Metadata = {
  ...
  description:
    "Infestation de cafards à Saint-Nicolas ? Traitement professionnel par gel insecticide ou pulvérisation. Résultat garanti, devis gratuit sous 24h. Techniciens certifiés.",
};
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="text-white py-14 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-green-100 text-lg max-w-2xl mb-6">
            ...
            Sayonarat vous met en contact avec un technicien certifié à Saint-Nicolas,
