...
export const metadata: Metadata = {
  ...
  description:
    "Infestation de cafards à Saint-Nicolas ? Traitement professionnel par gel insecticide ou pulvérisation. Résultat garanti, devis gratuit sous 24h. Techniciens professionnels.",
};
...
const faqs = [
  {
    q: "Comment savoir si j'ai des cafards dans mon logement à Saint-Nicolas ?",
  ...
  {
    q: "Pourquoi les cafards se propagent-ils à Saint-Nicolas ?",
    a: "Les immeubles de Tilleur et les maisons mitoyennes de Fragnée partagent des gaines communes qui permettent aux cafards de circuler entre logements voisins. La densité urbaine et la proximité avec Liège facilitent les réinfestations répétées.",
  },
  {
    q: "Combien coûte un traitement cafards à Saint-Nicolas ?",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Élimination cafards à Saint-Nicolas",
  provider: {
    "@type": "LocalBusiness",
    name: "Sayonarat",
    telephone: phone,
  ...
  description: "Service professionnel d'élimination de cafards à Saint-Nicolas. Traitement par gel insecticide, résultat garanti.",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Saint-Nicolas", item: "https://www.sayonarat.be/cafards-saint-nicolas" },
  ],
};

export default function CafardsSaintNicolasPage() {
  return (
    <>
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="text-white py-14 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-3xl md:text-4xl font-bold mb-4">
            Cafards à Saint-Nicolas — Élimination garantie | Sayonarat
          </h1>
          <p className="text-green-100 text-lg max-w-2xl mb-6">
            Une infestation de cafards s'étend vite et ne disparaît pas seule.
            Sayonarat vous met en contact avec un technicien professionnel à Saint-Nicolas,
      ...
      <section className="py-14 px-4 max-w-4xl mx-auto">
        <div className="relative rounded-2xl overflow-hidden shadow-lg h-64 md:h-80 mb-10">
          <Image
            ...
            alt={"Traitement cafards à Saint-Nicolas"}
            fill
            className="object-cover"
            priority
          />
          <div className="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent flex items-end p-5">
            <p className="text-white text-sm font-medium">Traitement professionnel cafards — Saint-Nicolas</p>
          </div>
        </div>

        <h2 className="text-2xl font-bold mb-4" style={{ color: "#1B4332" }}>
          Cafards à Saint-Nicolas : pourquoi agir vite ?
        </h2>
        <p className="text-gray-700 mb-6 leading-relaxed">
          La densité d'habitation de Saint-Nicolas, notamment dans les immeubles de Tilleur et les maisons mitoyennes de Fragnée, facilite la propagation des cafards via les gaines partagées. Les connexions directes avec Liège augmentent le risque d'introduction depuis la grande ville.
        </p>
        <p className="text-gray-700 mb-6 leading-relaxed">
        ...
        <div className="bg-yellow-50 border-l-4 border-yellow-400 p-5 rounded-r-xl mb-8">
          <p className="font-semibold text-gray-800 mb-3">Tarifs indicatifs — Cafards Saint-Nicolas</p>
      ...
      <section className="py-12 px-4 bg-gray-50">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-2xl font-bold mb-8 text-center" style={{ color: "#1B4332" }}>
            Questions fréquentes — Cafards Saint-Nicolas
          </h2>
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="py-14 px-4 text-white text-center">
        <h2 className="text-2xl font-bold mb-3">Cafards à Saint-Nicolas ? Agissez maintenant.</h2>
