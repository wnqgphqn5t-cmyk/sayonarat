...
const jsonLd = {
  ...
  mainEntityOfPage: {
    "@type": "WebPage",
    "@id": "https://www.sayonarat.be/blog/cafards-cuisine-que-faire",
  },
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Cafards cuisine", item: "https://www.sayonarat.be/blog/cafards-cuisine-que-faire" },
  ],
};
