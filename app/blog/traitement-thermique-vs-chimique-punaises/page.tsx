...
const jsonLd = {
  ...
  mainEntityOfPage: { "@type": "WebPage", "@id": "https://www.sayonarat.be/blog/traitement-thermique-vs-chimique-punaises" },
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Thermique vs chimique", item: "https://www.sayonarat.be/blog/traitement-thermique-vs-chimique-punaises" },
  ],
};
