...
const jsonLd = {
  ...
  mainEntityOfPage: { "@type": "WebPage", "@id": "https://www.sayonarat.be/blog/mites-alimentaires-que-faire" },
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Mites alimentaires", item: "https://www.sayonarat.be/blog/mites-alimentaires-que-faire" },
  ],
};
