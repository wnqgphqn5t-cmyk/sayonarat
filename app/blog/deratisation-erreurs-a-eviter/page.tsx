...
const jsonLd = {
  ...
  mainEntityOfPage: { "@type": "WebPage", "@id": "https://www.sayonarat.be/blog/deratisation-erreurs-a-eviter" },
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Erreurs dératisation", item: "https://www.sayonarat.be/blog/deratisation-erreurs-a-eviter" },
  ],
};
