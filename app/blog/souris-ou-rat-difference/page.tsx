...
const jsonLd = {
  ...
  mainEntityOfPage: { "@type": "WebPage", "@id": "https://www.sayonarat.be/blog/souris-ou-rat-difference" },
};
...
const faq = [
  ...
  },
  {
    ...
    a: "Entre 150 € et 450 € pour une maison unifamiliale. Pour les souris seules, entre 120 € et 280 €. Le tarif varie selon la superficie et l'ampleur de l'infestation. Devis gratuit sous 24h chez Sayonarat.",
  },
];
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Souris ou rat", item: "https://www.sayonarat.be/blog/souris-ou-rat-difference" },
  ],
};
