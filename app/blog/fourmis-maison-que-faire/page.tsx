...
const jsonLd = {
  ...
  mainEntityOfPage: { "@type": "WebPage", "@id": "https://www.sayonarat.be/blog/fourmis-maison-que-faire" },
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Fourmis maison", item: "https://www.sayonarat.be/blog/fourmis-maison-que-faire" },
  ],
};
