...
export const metadata: Metadata = {
  alternates: { canonical: "/cafards-bruxelles" },
  title: "Cafards Bruxelles — Élimination garantie, intervention rapide",
  description:
    "Infestation de cafards à Bruxelles ? Traitement professionnel par gel insecticide ou pulvérisation. Résultat garanti, devis gratuit sous 24h. Techniciens professionnels.",
};
...
const faqs = [
  {
    q: "Comment savoir si j'ai des cafards dans mon logement à Bruxelles ?",
  ...
  {
    q: "Pourquoi les cafards se propagent-ils à Bruxelles ?",
    a: "Les immeubles anciens du 19e siècle d'Ixelles, Molenbeek et Schaerbeek comportent des gaines et des sous-sols communicants où les cafards prolifèrent et se déplacent entre appartements. La rotation fréquente des locataires facilite également l'introduction de nouvelles colonies.",
  },
  {
    q: "Combien coûte un traitement cafards à Bruxelles ?",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Élimination cafards à Bruxelles",
  provider: {
    "@type": "LocalBusiness",
    name: "Sayonarat",
    telephone: phone,
  ...
  description: "Service professionnel d'élimination de cafards à Bruxelles. Traitement par gel insecticide, résultat garanti.",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Bruxelles", item: "https://www.sayonarat.be/cafards-bruxelles" },
  ],
};

export default function CafardsBruxellesPage() {
  return (
    <>
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="text-white py-14 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-3xl md:text-4xl font-bold mb-4">
            Cafards à Bruxelles — Élimination garantie | Sayonarat
          </h1>
          <p className="text-green-100 text-lg max-w-2xl mb-6">
            Une infestation de cafards s'étend vite et ne disparaît pas seule.
            Sayonarat vous met en contact avec un technicien professionnel à Bruxelles,
      ...
      <section className="py-14 px-4 max-w-4xl mx-auto">
        <div className="relative rounded-2xl overflow-hidden shadow-lg h-64 md:h-80 mb-10">
          <Image
            ...
            alt={"Traitement cafards à Bruxelles"}
            fill
            className="object-cover"
            priority
          />
          <div className="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent flex items-end p-5">
            <p className="text-white text-sm font-medium">Traitement professionnel cafards — Bruxelles</p>
          </div>
        </div>

        <h2 className="text-2xl font-bold mb-4" style={{ color: "#1B4332" }}>
          Cafards à Bruxelles : pourquoi agir vite ?
        </h2>
        <p className="text-gray-700 mb-6 leading-relaxed">
          Bruxelles présente l'une des densités d'infestation de cafards les plus élevées de Belgique. Les immeubles anciens d'Ixelles, Molenbeek et Schaerbeek comportent de nombreuses gaines communes et des sous-sols communicants. Les kots étudiants et les établissements HoReCa sont également très exposés.
        </p>
        <p className="text-gray-700 mb-6 leading-relaxed">
        ...
        <div className="bg-yellow-50 border-l-4 border-yellow-400 p-5 rounded-r-xl mb-8">
          <p className="font-semibold text-gray-800 mb-3">Tarifs indicatifs — Cafards Bruxelles</p>
      ...
      <section className="py-12 px-4 bg-gray-50">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-2xl font-bold mb-8 text-center" style={{ color: "#1B4332" }}>
            Questions fréquentes — Cafards Bruxelles
          </h2>
      ...
      <section className="py-10 px-4 max-w-4xl mx-auto">
        ...
        <div className="flex flex-wrap gap-3 text-sm">
          {[
            ...
            { label: "Cafards Charleroi", href: "/cafards-charleroi" },
            { label: "Cafards Namur", href: "/cafards-namur" },
            { label: "Cafards Mons", href: "/cafards-mons" },
          ].map((l) => (
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="py-14 px-4 text-white text-center">
        <h2 className="text-2xl font-bold mb-3">Cafards à Bruxelles ? Agissez maintenant.</h2>
