...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Ans", item: "https://www.sayonarat.be/guepes-frelons-ans" },
  ],
};
      ...
      <section className="py-14 px-4 max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-10">
          {[
            ...
            { emoji: "🛡️", t: "Équipement professionnel", d: "Protection intégrale. Produits professionnels homologués." },
