...
export const metadata: Metadata = {
  alternates: { canonical: "/mites-alimentaires-bruxelles" },
  title: "Mites alimentaires Bruxelles — Traitement professionnel",
  description:
    "Mites alimentaires à Bruxelles ? Traitement professionnel contre les mites des denrées. Intervention sous 48h, devis gratuit. Garantie de réintervention.",
};

const jsonLd = {
  "@context": "https://schema.org",
  "@type": "Service",
  name: "Traitement mites alimentaires à Bruxelles",
  provider: {
    "@type": "LocalBusiness",
    name: "Sayonarat",
    telephone: phone,
  ...
  description: "Service de traitement contre les mites alimentaires à Bruxelles. Intervention rapide, produits homologués.",
  serviceType: "PestControl",
};

const faqs = [
  {
    q: "Comment savoir si j'ai des mites alimentaires à Bruxelles ?",
  ...
  {
    q: "Comment les mites alimentaires arrivent-elles dans un logement à Bruxelles ?",
    a: "À Bruxelles, souvent via des produits achetés dans les nombreux épiceries exotiques et magasins bio de Ixelles et Molenbeek. Les appartements avec peu de rotation des stocks alimentaires sont les plus vulnérables.",
  },
  {
  ...
  {
    q: "Combien coûte un traitement mites alimentaires à Bruxelles ?",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Bruxelles", item: "https://www.sayonarat.be/mites-alimentaires-bruxelles" },
  ],
};

export default function MitesAlimentairesBruxellesPage() {
  return (
    <>
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="text-white py-14 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-3xl md:text-4xl font-bold mb-4">
            Mites alimentaires à Bruxelles — Traitement professionnel
          </h1>
          <p className="text-green-100 text-lg max-w-2xl mb-6">
            Larves dans la farine, papillons dans les placards ? Sayonarat intervient pour
            éliminer les mites des denrées à Bruxelles. Devis gratuit sous 24h.
          </p>
      ...
      <section className="py-14 px-4 max-w-4xl mx-auto">
        <h2 className="text-2xl font-bold mb-4" style={{ color: "#1B4332" }}>
          Mites alimentaires à Bruxelles
        </h2>
        <p className="text-gray-700 mb-4 leading-relaxed">
          Les appartements bruxellois, souvent avec des cuisines compactes et des placards peu ventilés, sont très exposés aux mites alimentaires. Les épiceries fines et les importateurs de denrées d'Ixelles et Molenbeek peuvent être des sources de contamination.
        </p>
        ...
        <div className="p-6 rounded-2xl text-white text-center" style={{ backgroundColor: "#1B4332" }}>
          <h2 className="text-xl font-bold mb-2">Des mites alimentaires à Bruxelles ?</h2>
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="py-14 px-4 text-white text-center">
        <h2 className="text-2xl font-bold mb-3">Mites alimentaires à Bruxelles ?</h2>
