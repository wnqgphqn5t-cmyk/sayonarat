...
export const metadata: Metadata = {
  alternates: { canonical: "/cafards-awans" },
  title: "Cafards Awans — Élimination garantie, intervention rapide",
  description:
    "Infestation de cafards à Awans ? Traitement professionnel par gel insecticide ou pulvérisation. Résultat garanti, devis gratuit sous 24h. Techniciens professionnels.",
};
...
const faqs = [
  {
    q: "Comment savoir si j'ai des cafards dans mon logement à Awans ?",
  ...
  {
    q: "Pourquoi les cafards se propagent-ils à Awans ?",
    a: "Les maisons anciennes de Fooz et Villers-l'Évêque ont souvent des fissures dans les murs qui servent de refuges. Les conduits de gaz et d'eau vieillissants offrent également des voies de passage. Un diagnostic complet est indispensable avant tout traitement.",
  },
  {
    q: "Combien coûte un traitement cafards à Awans ?",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Élimination cafards à Awans",
  provider: {
    "@type": "LocalBusiness",
    name: "Sayonarat",
    telephone: phone,
  ...
  areaServed: "Awans",
  description: "Service professionnel d'élimination de cafards à Awans. Traitement par gel insecticide, résultat garanti.",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Awans", item: "https://www.sayonarat.be/cafards-awans" },
  ],
};

export default function CafardsAwansPage() {
  return (
    <>
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="text-white py-14 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-3xl md:text-4xl font-bold mb-4">
            Cafards à Awans — Élimination garantie | Sayonarat
          </h1>
          <p className="text-green-100 text-lg max-w-2xl mb-6">
            Une infestation de cafards s'étend vite et ne disparaît pas seule.
            Sayonarat vous met en contact avec un technicien professionnel à Awans,
      ...
      <section className="py-14 px-4 max-w-4xl mx-auto">
        <div className="relative rounded-2xl overflow-hidden shadow-lg h-64 md:h-80 mb-10">
          <Image
            ...
            alt={"Traitement cafards à Awans"}
            fill
            className="object-cover"
            priority
          />
          <div className="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent flex items-end p-5">
            <p className="text-white text-sm font-medium">Traitement professionnel cafards — Awans</p>
          </div>
        </div>

        <h2 className="text-2xl font-bold mb-4" style={{ color: "#1B4332" }}>
          Cafards à Awans : pourquoi agir vite ?
        </h2>
        <p className="text-gray-700 mb-6 leading-relaxed">
          Les maisons anciennes de Fooz et Villers-l'Évêque présentent souvent des fissures dans les murs et des gaines vieillissantes propices aux blattes. Dans les logements collectifs d'Awans, les cafards circulent par les conduits de ventilation et les caves communicantes.
        </p>
        <p className="text-gray-700 mb-6 leading-relaxed">
      ...
      <section className="py-12 px-4 bg-gray-50">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-2xl font-bold mb-8 text-center" style={{ color: "#1B4332" }}>
            Questions fréquentes — Cafards Awans
          </h2>
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="py-14 px-4 text-white text-center">
        <h2 className="text-2xl font-bold mb-3">Cafards à Awans ? Agissez maintenant.</h2>
