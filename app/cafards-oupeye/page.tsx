...
export const metadata: Metadata = {
  ...
  description:
    "Infestation de cafards à Oupeye ? Traitement professionnel par gel insecticide ou pulvérisation. Résultat garanti, devis gratuit sous 24h. Techniciens professionnels.",
};
...
const faqs = [
  {
    q: "Comment savoir si j'ai des cafards dans mon logement à Oupeye ?",
  ...
  {
    q: "Pourquoi les cafards se propagent-ils à Oupeye ?",
    a: "Les maisons mitoyennes d'Hermalle et Haccourt ont souvent des caves communicantes et des gaines partagées qui facilitent la propagation des cafards entre voisins. Les tuyauteries vieillissantes en bord de Meuse créent également des voies de passage entre logements.",
  },
  {
    q: "Combien coûte un traitement cafards à Oupeye ?",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Élimination cafards à Oupeye",
  provider: {
    "@type": "LocalBusiness",
    name: "Sayonarat",
    telephone: phone,
  ...
  areaServed: "Oupeye",
  description: "Service professionnel d'élimination de cafards à Oupeye. Traitement par gel insecticide, résultat garanti.",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Oupeye", item: "https://www.sayonarat.be/cafards-oupeye" },
  ],
};

export default function CafardsOupeyePage() {
  return (
    <>
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="text-white py-14 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-3xl md:text-4xl font-bold mb-4">
            Cafards à Oupeye — Élimination garantie | Sayonarat
          </h1>
          <p className="text-green-100 text-lg max-w-2xl mb-6">
            Une infestation de cafards s'étend vite et ne disparaît pas seule.
            Sayonarat vous met en contact avec un technicien professionnel à Oupeye,
      ...
      <section className="py-14 px-4 max-w-4xl mx-auto">
        <div className="relative rounded-2xl overflow-hidden shadow-lg h-64 md:h-80 mb-10">
          <Image
            ...
            alt={"Traitement cafards à Oupeye"}
            fill
            className="object-cover"
            priority
          />
          <div className="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent flex items-end p-5">
            <p className="text-white text-sm font-medium">Traitement professionnel cafards — Oupeye</p>
          </div>
        </div>

        <h2 className="text-2xl font-bold mb-4" style={{ color: "#1B4332" }}>
          Cafards à Oupeye : pourquoi agir vite ?
        </h2>
        <p className="text-gray-700 mb-6 leading-relaxed">
          Les vieilles cités ouvrières d'Hermalle-sous-Argenteau et Haccourt, avec leurs maisons mitoyennes et leurs gaines communes vieillissantes, sont particulièrement exposées. Les blattes orientales sont fréquentes dans les sous-sols humides en bord de Meuse.
        </p>
        <p className="text-gray-700 mb-6 leading-relaxed">
        ...
        <div className="bg-yellow-50 border-l-4 border-yellow-400 p-5 rounded-r-xl mb-8">
          <p className="font-semibold text-gray-800 mb-3">Tarifs indicatifs — Cafards Oupeye</p>
      ...
      <section className="py-12 px-4 bg-gray-50">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-2xl font-bold mb-8 text-center" style={{ color: "#1B4332" }}>
            Questions fréquentes — Cafards Oupeye
          </h2>
      ...
      <section className="py-10 px-4 max-w-4xl mx-auto">
        ...
        <div className="flex flex-wrap gap-3 text-sm">
          {[
            ...
            { label: "Cafards Awans", href: "/cafards-awans" },
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="py-14 px-4 text-white text-center">
        <h2 className="text-2xl font-bold mb-3">Cafards à Oupeye ? Agissez maintenant.</h2>
