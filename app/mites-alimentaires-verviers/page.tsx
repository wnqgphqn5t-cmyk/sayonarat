...
export const metadata: Metadata = {
  alternates: { canonical: "/mites-alimentaires-verviers" },
  title: "Mites alimentaires Verviers — Traitement professionnel",
  description:
    "Mites alimentaires à Verviers ? Traitement professionnel contre les mites des denrées. Intervention sous 48h, devis gratuit. Garantie de réintervention.",
};

const jsonLd = {
  "@context": "https://schema.org",
  "@type": "Service",
  name: "Traitement mites alimentaires à Verviers",
  provider: {
    "@type": "LocalBusiness",
    name: "Sayonarat",
    telephone: phone,
  ...
  areaServed: "Verviers",
  description: "Service de traitement contre les mites alimentaires à Verviers. Intervention rapide, produits homologués.",
  serviceType: "PestControl",
};

const faqs = [
  {
    q: "Comment savoir si j'ai des mites alimentaires à Verviers ?",
  ...
  {
    q: "Comment les mites alimentaires arrivent-elles dans un logement à Verviers ?",
    a: "L'humidité ambiante de la vallée de la Vesdre crée des conditions idéales pour les larves de mites : elles se développent plus vite dans un environnement humide. Les logements anciens du centre de Verviers, avec leurs placards peu ventilés, sont les plus vulnérables.",
  },
  {
  ...
  {
    q: "Combien coûte un traitement mites alimentaires à Verviers ?",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Verviers", item: "https://www.sayonarat.be/mites-alimentaires-verviers" },
  ],
};

export default function MitesAlimentairesVerviersPage() {
  return (
    <>
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="text-white py-14 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-3xl md:text-4xl font-bold mb-4">
            Mites alimentaires à Verviers — Traitement professionnel
          </h1>
      ...
      <section className="py-14 px-4 max-w-4xl mx-auto">
        <h2 className="text-2xl font-bold mb-4" style={{ color: "#1B4332" }}>
          Mites alimentaires à Verviers
        </h2>
        <p className="text-gray-700 mb-4 leading-relaxed">
          L'humidité de la vallée de la Vesdre favorise particulièrement l'éclosion des larves de mites alimentaires. Les logements anciens du centre de Verviers et des faubourgs d'Ensival sont les plus exposés, notamment en été lors des périodes de chaleur humide.
        </p>
        ...
        <div className="p-6 rounded-2xl text-white text-center" style={{ backgroundColor: "#1B4332" }}>
          <h2 className="text-xl font-bold mb-2">Des mites alimentaires à Verviers ?</h2>
        ...
        <div className="mt-10 pt-6 border-t border-gray-100">
          ...
          <div className="flex flex-wrap gap-3 text-sm">
            ...
            <Link href="/mites-alimentaires-beyne-heusay" className="underline" style={{ color: "#1B4332" }}>Mites alimentaires Beyne-Heusay</Link>
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="py-14 px-4 text-white text-center">
        <h2 className="text-2xl font-bold mb-3">Mites alimentaires à Verviers ?</h2>
