...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Charleroi", item: "https://www.sayonarat.be/punaises-de-lit-charleroi" },
  ],
};
      ...
      <section className="py-14 px-4 max-w-4xl mx-auto">
        ...
        <div className="bg-yellow-50 border-l-4 border-yellow-400 p-5 rounded-r-xl mb-10">
          ...
          <p className="text-sm text-gray-700 mt-1">
            Toutes nos interventions à Charleroi sont couvertes par une garantie de réintervention.
