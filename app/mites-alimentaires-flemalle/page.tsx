...
export const metadata: Metadata = {
  ...
  description:
    "Mites alimentaires à Flémalle ? Traitement professionnel contre les mites des denrées. Intervention sous 48h, devis gratuit. Garantie de réintervention.",
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Flémalle", item: "https://www.sayonarat.be/mites-alimentaires-flemalle" },
  ],
};
