...
export const metadata: Metadata = {
  ...
  description:
    "Invasion de fourmis à Herstal ? Fourmis charpentières, pharaon, des jardins. Traitement par gel transmissible. Devis gratuit sous 24h, garantie de réintervention.",
};

const faqs = [
  {
    q: "Comment identifier l'espèce de fourmis dans mon logement à Herstal ?",
  ...
  {
    q: "Les fourmis pharaon sont-elles présentes à Herstal ?",
    a: "Oui, les fourmis pharaon sont bien présentes dans les immeubles collectifs de Herstal, notamment à Vottem et Milmort. Elles se déplacent dans les gaines et les espaces creux. Les fourmis des jardins colonisent les espaces verts des cités.",
  },
  {
    q: "Combien coûte un traitement fourmis à Herstal ?",
  ...
  },
  {
    ...
    a: "Pour les fourmis des jardins : 1 à 2 semaines après application du gel. Pour les fourmis pharaon : 3 à 6 semaines — les ouvrières rapportent le gel à la reine. Une garantie de réintervention est incluse dans tous nos traitements à Herstal.",
  },
];
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Traitement fourmis à Herstal",
  provider: {
    "@type": "LocalBusiness",
    name: "Sayonarat",
    telephone: phone,
  ...
  areaServed: "Herstal",
  description: "Traitement professionnel contre les fourmis à Herstal. Fourmis pharaon, charpentières, des jardins. Gel transmissible, garantie de réintervention.",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "Désinsectisation Herstal", item: "https://www.sayonarat.be/desinsectisation-herstal" },
    { "@type": "ListItem", position: 3, name: "Herstal", item: "https://www.sayonarat.be/fourmis-herstal" },
  ],
};

export default function FourmisHerstalPage() {
  return (
    <>
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="text-white py-14 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-3xl md:text-4xl font-bold mb-4">
            Fourmis à Herstal — Traitement professionnel garanti
          </h1>
      ...
      <section className="py-10 px-4 max-w-4xl mx-auto">
        <div className="relative rounded-2xl overflow-hidden shadow-lg h-64 mb-10">
          <Image
            ...
            alt={"Traitement fourmis Herstal"}
            fill
            className="object-cover"
            priority
          />
          <div className="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent flex items-end p-5">
            <p className="text-white text-sm font-medium">Traitement fourmis par gel professionnel — Herstal</p>
          </div>
        </div>

        <h2 className="text-2xl font-bold mb-4" style={{ color: "#1B4332" }}>
          Fourmis à Herstal : un problème fréquent
        </h2>
        <p className="text-gray-700 mb-6 leading-relaxed">
          Les cités ouvrières de Vottem et Liers, avec leurs jardins communautaires et leurs allées pavées, offrent de nombreux espaces favorables aux fourmis des jardins. Les fourmis pharaon sont également signalées dans les immeubles collectifs de Milmort.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-10">
          {[
            ...
            { emoji: "✅", t: "Garantie incluse", d: "Si des fourmis réapparaissent pendant la période de garantie, retour sans frais. Inclus dans toutes nos interventions à Herstal." },
          ].map((card) => (
        ...
        <div className="bg-yellow-50 border-l-4 border-yellow-400 p-5 rounded-r-xl mb-10">
          <p className="font-semibold text-gray-800 mb-3">Tarifs indicatifs — Fourmis Herstal</p>
      ...
      <section className="py-12 px-4 bg-gray-50">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-2xl font-bold mb-8 text-center" style={{ color: "#1B4332" }}>
            Questions fréquentes — Fourmis Herstal
          </h2>
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="py-14 px-4 text-white text-center">
        <h2 className="text-2xl font-bold mb-3">Fourmis à Herstal ?</h2>
