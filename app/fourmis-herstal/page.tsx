...
export const metadata: Metadata = {
  ...
  description:
    "Invasion de fourmis à Herstal ? Fourmis charpentières, pharaon, des jardins. Traitement par gel transmissible. Devis gratuit sous 24h, garantie 30 jours.",
};
...
const faqs = [
  ...
  },
  {
    ...
    a: "Pour les fourmis des jardins : 1 à 2 semaines après application du gel. Pour les fourmis pharaon : 3 à 6 semaines — les ouvrières rapportent le gel à la reine. Une garantie 30 jours est incluse dans tous nos traitements à Herstal.",
  },
];
...
const jsonLd = {
  ...
  areaServed: "Herstal",
  description: "Traitement professionnel contre les fourmis à Herstal. Fourmis pharaon, charpentières, des jardins. Gel transmissible, garantie 30 jours.",
