...
export const metadata: Metadata = {
  ...
  description:
    "Infestation de cafards à Charleroi ? Traitement professionnel par gel insecticide ou pulvérisation. Résultat garanti, devis gratuit sous 24h. Techniciens professionnels.",
};
...
const faqs = [
  {
    q: "Comment savoir si j'ai des cafards dans mon logement à Charleroi ?",
  ...
  {
    q: "Pourquoi les cafards se propagent-ils à Charleroi ?",
    a: "Les immeubles anciens du centre de Charleroi ont des gaines et des sous-sols parfois communicants entre bâtiments mitoyens, facilitant la propagation. Les blattes orientales affectionnent les sous-sols humides des maisons du 19e siècle, fréquentes dans le bassin industriel.",
  },
  {
    q: "Combien coûte un traitement cafards à Charleroi ?",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Élimination cafards à Charleroi",
  provider: {
    "@type": "LocalBusiness",
    name: "Sayonarat",
    telephone: phone,
  ...
  description: "Service professionnel d'élimination de cafards à Charleroi. Traitement par gel insecticide, résultat garanti.",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Charleroi", item: "https://www.sayonarat.be/cafards-charleroi" },
  ],
};

export default function CafardsCharleroiPage() {
  return (
    <>
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="text-white py-14 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-3xl md:text-4xl font-bold mb-4">
            Cafards à Charleroi — Élimination garantie | Sayonarat
          </h1>
          <p className="text-green-100 text-lg max-w-2xl mb-6">
            Une infestation de cafards s'étend vite et ne disparaît pas seule.
            Sayonarat vous met en contact avec un technicien professionnel à Charleroi,
      ...
      <section className="py-14 px-4 max-w-4xl mx-auto">
        <div className="relative rounded-2xl overflow-hidden shadow-lg h-64 md:h-80 mb-10">
          <Image
            ...
            alt={"Traitement cafards à Charleroi"}
            fill
            className="object-cover"
            priority
          />
          <div className="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent flex items-end p-5">
            <p className="text-white text-sm font-medium">Traitement professionnel cafards — Charleroi</p>
          </div>
        </div>

        <h2 className="text-2xl font-bold mb-4" style={{ color: "#1B4332" }}>
          Cafards à Charleroi : pourquoi agir vite ?
        </h2>
        <p className="text-gray-700 mb-6 leading-relaxed">
          Les immeubles anciens du centre de Charleroi et les maisons ouvrières de Gilly et Marchienne-au-Pont présentent de nombreuses fissures et gaines vieillissantes propices aux cafards. Les blattes orientales sont particulièrement fréquentes dans les sous-sols humides du bassin industriel.
        </p>
        <p className="text-gray-700 mb-6 leading-relaxed">
        ...
        <div className="bg-yellow-50 border-l-4 border-yellow-400 p-5 rounded-r-xl mb-8">
          <p className="font-semibold text-gray-800 mb-3">Tarifs indicatifs — Cafards Charleroi</p>
      ...
      <section className="py-12 px-4 bg-gray-50">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-2xl font-bold mb-8 text-center" style={{ color: "#1B4332" }}>
            Questions fréquentes — Cafards Charleroi
          </h2>
      ...
      <section className="py-10 px-4 max-w-4xl mx-auto">
        ...
        <div className="flex flex-wrap gap-3 text-sm">
          {[
            ...
            { label: "Cafards Bruxelles", href: "/cafards-bruxelles" },
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="py-14 px-4 text-white text-center">
        <h2 className="text-2xl font-bold mb-3">Cafards à Charleroi ? Agissez maintenant.</h2>
