...
export const metadata: Metadata = {
  alternates: { canonical: "/fourmis-seraing" },
  title: "Fourmis Seraing — Traitement professionnel garanti",
  description:
    "Invasion de fourmis à Seraing ? Fourmis charpentières, pharaon, des jardins. Traitement par gel transmissible. Devis gratuit sous 24h, garantie de réintervention.",
};

const faqs = [
  {
    q: "Comment identifier l'espèce de fourmis dans mon logement à Seraing ?",
  ...
  {
    q: "Les fourmis pharaon sont-elles présentes à Seraing ?",
    a: "Les fourmis charpentières sont particulièrement présentes dans les vieilles charpentes des maisons ouvrières de Seraing. Les fourmis des jardins colonisent les espaces verts des cités de Jemeppe. Les fourmis pharaon sont signalées dans les immeubles collectifs d'Ougrée.",
  },
  {
    q: "Combien coûte un traitement fourmis à Seraing ?",
  ...
  },
  {
    ...
    a: "Pour les fourmis des jardins : 1 à 2 semaines après application du gel. Pour les fourmis pharaon : 3 à 6 semaines — les ouvrières rapportent le gel à la reine. Une garantie de réintervention est incluse dans tous nos traitements à Seraing.",
  },
];
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Traitement fourmis à Seraing",
  provider: {
    "@type": "LocalBusiness",
    name: "Sayonarat",
    telephone: phone,
  ...
  areaServed: "Seraing",
  description: "Traitement professionnel contre les fourmis à Seraing. Fourmis pharaon, charpentières, des jardins. Gel transmissible, garantie de réintervention.",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "Désinsectisation Seraing", item: "https://www.sayonarat.be/desinsectisation-seraing" },
    { "@type": "ListItem", position: 3, name: "Seraing", item: "https://www.sayonarat.be/fourmis-seraing" },
  ],
};

export default function FourmisSeraingPage() {
  return (
    <>
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="text-white py-14 px-4">
        <div className="max-w-4xl mx-auto">
          <p className="text-green-300 text-sm mb-2">
            ...
            <Link href="/desinsectisation-seraing" className="hover:text-white">Désinsectisation Seraing</Link> ›{" "}
            Seraing
          </p>
          <h1 className="text-3xl md:text-4xl font-bold mb-4">
            Fourmis à Seraing — Traitement professionnel garanti
          </h1>
      ...
      <section className="py-10 px-4 max-w-4xl mx-auto">
        <div className="relative rounded-2xl overflow-hidden shadow-lg h-64 mb-10">
          <Image
            ...
            alt={"Traitement fourmis Seraing"}
            fill
            className="object-cover"
            priority
          />
          <div className="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent flex items-end p-5">
            <p className="text-white text-sm font-medium">Traitement fourmis par gel professionnel — Seraing</p>
          </div>
        </div>

        <h2 className="text-2xl font-bold mb-4" style={{ color: "#1B4332" }}>
          Fourmis à Seraing : un problème fréquent
        </h2>
        <p className="text-gray-700 mb-6 leading-relaxed">
          Les jardins des cités ouvrières de Jemeppe et Ougrée, les parcs en bord de Meuse et les friches industrielles de Seraing offrent de nombreux espaces propices aux colonies de fourmis des jardins. Les fourmis charpentières sont fréquentes dans les vieilles charpentes des maisons ouvrières.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-10">
          {[
            ...
            { emoji: "✅", t: "Garantie incluse", d: "Si des fourmis réapparaissent pendant la période de garantie, retour sans frais. Inclus dans toutes nos interventions à Seraing." },
          ].map((card) => (
        ...
        <div className="bg-yellow-50 border-l-4 border-yellow-400 p-5 rounded-r-xl mb-10">
          <p className="font-semibold text-gray-800 mb-3">Tarifs indicatifs — Fourmis Seraing</p>
      ...
      <section className="py-12 px-4 bg-gray-50">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-2xl font-bold mb-8 text-center" style={{ color: "#1B4332" }}>
            Questions fréquentes — Fourmis Seraing
          </h2>
      ...
      <section className="py-10 px-4 max-w-4xl mx-auto">
        ...
        <div className="flex flex-wrap gap-3 text-sm">
          {[
            ...
            { label: "Fourmis Saint-Nicolas", href: "/fourmis-saint-nicolas" },
            { label: "Fourmis Flémalle", href: "/fourmis-flemalle" },
            { label: "Fourmis Grâce-Hollogne", href: "/fourmis-grace-hollogne" }
          ].map((l) => (
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="py-14 px-4 text-white text-center">
        <h2 className="text-2xl font-bold mb-3">Fourmis à Seraing ?</h2>
