...
export const metadata: Metadata = {
  alternates: { canonical: "/fourmis-bruxelles" },
  title: "Fourmis Bruxelles — Traitement professionnel garanti",
  description:
    "Invasion de fourmis à Bruxelles ? Fourmis charpentières, pharaon, des jardins. Traitement par gel transmissible. Devis gratuit sous 24h, garantie de réintervention.",
};

const faqs = [
  {
    q: "Comment identifier l'espèce de fourmis dans mon logement à Bruxelles ?",
  ...
  {
    q: "Les fourmis pharaon sont-elles présentes à Bruxelles ?",
    a: "Oui, les fourmis pharaon sont très répandues dans les immeubles bruxellois anciens d'Ixelles, Saint-Gilles et Molenbeek. Elles se déplacent dans les murs creux et les gaines. Ne jamais utiliser de spray — cela déclenche le budding et multiplie les colonies.",
  },
  {
    q: "Combien coûte un traitement fourmis à Bruxelles ?",
  ...
  },
  {
    ...
    a: "Pour les fourmis des jardins : 1 à 2 semaines après application du gel. Pour les fourmis pharaon : 3 à 6 semaines — les ouvrières rapportent le gel à la reine. Une garantie de réintervention est incluse dans tous nos traitements à Bruxelles.",
  },
];
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Traitement fourmis à Bruxelles",
  provider: {
    "@type": "LocalBusiness",
    name: "Sayonarat",
    telephone: phone,
  ...
  description: "Traitement professionnel contre les fourmis à Bruxelles. Fourmis pharaon, charpentières, des jardins. Gel transmissible, garantie de réintervention.",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Bruxelles", item: "https://www.sayonarat.be/fourmis-bruxelles" },
  ],
};

export default function FourmisBruxellesPage() {
  return (
    <>
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="text-white py-14 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-3xl md:text-4xl font-bold mb-4">
            Fourmis à Bruxelles — Traitement professionnel garanti
          </h1>
      ...
      <section className="py-10 px-4 max-w-4xl mx-auto">
        <div className="relative rounded-2xl overflow-hidden shadow-lg h-64 mb-10">
          <Image
            ...
            alt={"Traitement fourmis Bruxelles"}
            fill
            className="object-cover"
            priority
          />
          <div className="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent flex items-end p-5">
            <p className="text-white text-sm font-medium">Traitement fourmis par gel professionnel — Bruxelles</p>
          </div>
        </div>

        <h2 className="text-2xl font-bold mb-4" style={{ color: "#1B4332" }}>
          Fourmis à Bruxelles : un problème fréquent
        </h2>
        <p className="text-gray-700 mb-6 leading-relaxed">
          Les immeubles bruxellois du 19e siècle d'Ixelles, Saint-Gilles et Schaerbeek sont des habitats idéaux pour les fourmis pharaon dans les murs creux et faux-plafonds. Les cours intérieures et jardins partagés favorisent les fourmis charpentières.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-10">
          {[
            ...
            { emoji: "✅", t: "Garantie incluse", d: "Si des fourmis réapparaissent pendant la période de garantie, retour sans frais. Inclus dans toutes nos interventions à Bruxelles." },
          ].map((card) => (
        ...
        <div className="bg-yellow-50 border-l-4 border-yellow-400 p-5 rounded-r-xl mb-10">
          <p className="font-semibold text-gray-800 mb-3">Tarifs indicatifs — Fourmis Bruxelles</p>
      ...
      <section className="py-12 px-4 bg-gray-50">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-2xl font-bold mb-8 text-center" style={{ color: "#1B4332" }}>
            Questions fréquentes — Fourmis Bruxelles
          </h2>
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="py-14 px-4 text-white text-center">
        <h2 className="text-2xl font-bold mb-3">Fourmis à Bruxelles ?</h2>
