...
export const metadata: Metadata = {
  ...
  description:
    "Dératisation professionnelle à Verviers. Rats dans la vallée de la Vesdre, anciens bâtiments textiles, proximité Liège. Devis gratuit sous 24h, garantie de réintervention.",
};
...
const jsonLd = {
  ...
  areaServed: "Verviers",
  description: "Service de dératisation professionnelle à Verviers. Rats dans la vallée de la Vesdre et anciens bâtiments textiles. Techniciens professionnels, garantie de réintervention.",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Verviers", item: "https://www.sayonarat.be/deratisation-verviers" },
  ],
};
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="text-white py-14 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-green-100 text-lg max-w-2xl mb-6">
            ...
            et tous les quartiers verviétois. Techniciens professionnels, garantie de réintervention.
          </p>
      ...
      <section className="py-14 px-4 max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-10">
          {[
            ...
            { emoji: "🎯", t: "Traitement ciblé", d: "Appâts rodenticides autorisés (SPF), colmatage des accès, protection durable contre les réinfestations depuis les berges et sous-sols industriels." },
