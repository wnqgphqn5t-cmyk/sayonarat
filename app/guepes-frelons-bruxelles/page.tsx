...
export const metadata: Metadata = {
  alternates: { canonical: "/guepes-frelons-bruxelles" },
  title: "Guêpes et frelons Bruxelles — Destruction nid rapide",
  description:
    "Nid de guêpes ou frelons à Bruxelles ? Destruction professionnelle sous 48h. Intervention nocturne sécurisée, garantie résultat. Devis gratuit.",
};

const faqs = [
  {
    q: "Combien coûte la destruction d'un nid de guêpes à Bruxelles ?",
  ...
  {
    q: "Les guêpes à Bruxelles : quelles zones sont les plus touchées ?",
    a: "Les cours intérieures et jardins des maisons de maître d'Ixelles et Saint-Gilles sont les zones les plus touchées. Les parcs de Schaerbeek et Forest hébergent également de nombreux nids dans les arbres. Le frelon asiatique est très présent dans la région bruxelloise.",
  },
  {
    q: "Mon voisin a un nid de guêpes à Bruxelles, que faire ?",
  ...
  {
    q: "Le frelon asiatique est-il présent à Bruxelles ?",
    a: "Oui. Le frelon asiatique est désormais établi dans toute la Belgique, y compris à Bruxelles. Son nid, souvent perché à plus de 5 mètres de hauteur dans les arbres, est plus difficile à traiter qu'un nid de guêpes classique. Une intervention professionnelle avec équipement adapté est indispensable.",
  },
];
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Destruction nid guêpes et frelons à Bruxelles",
  provider: {
    "@type": "LocalBusiness",
    name: "Sayonarat",
    telephone: phone,
  ...
  description: "Service de destruction de nids de guêpes et frelons à Bruxelles. Intervention nocturne sécurisée, résultat garanti.",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "Désinsectisation Bruxelles", item: "https://www.sayonarat.be/desinsectisation-bruxelles" },
    { "@type": "ListItem", position: 3, name: "Bruxelles", item: "https://www.sayonarat.be/guepes-frelons-bruxelles" },
  ],
};

export default function GuepesFretonsBruxellesPage() {
  return (
    <>
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="text-white py-14 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-3xl md:text-4xl font-bold mb-4">
            Guêpes et frelons à Bruxelles — Destruction nid | Sayonarat
          </h1>
          <p className="text-green-100 text-lg max-w-2xl mb-6">
            Nid de guêpes dans vos combles ou jardin à Bruxelles ? Intervention nocturne
      ...
      <section className="py-14 px-4 max-w-4xl mx-auto">
        <div className="relative rounded-2xl overflow-hidden shadow-lg h-64 md:h-72 mb-10">
          <Image src="/nid-guepes.jpg" alt={"Nid de guêpes traité à Bruxelles"} fill className="object-cover" priority />
          <div className="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent flex items-end p-5">
            <p className="text-white text-sm font-medium">Destruction de nid de guêpes — Bruxelles</p>
          </div>
        </div>
        ...
        <h2 className="text-2xl font-bold mb-4" style={{ color: "#1B4332" }}>Nids de guêpes à Bruxelles : une capitale de la Belgique avec sa haute densité d'immeubles anciens et ses nombreux jardins et parcs. Les cours intérieures des maisons de maître d'Ixelles et Saint-Gilles, ainsi que les parcs de Schaerbeek, concentrent de nombreux nids de guêpes et de frelons.</h2>
        <p className="text-gray-700 mb-8 leading-relaxed">
          ...
          Ixelles, Saint-Gilles et Schaerbeek concentrent la plupart des signalements, notamment dans les cours intérieures des maisons de maître et les jardins des maisons individuelles.
        </p>
      ...
      <section className="py-12 px-4 bg-gray-50">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-2xl font-bold mb-8 text-center" style={{ color: "#1B4332" }}>Questions fréquentes — Guêpes Bruxelles</h2>
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="py-14 px-4 text-white text-center">
        <h2 className="text-2xl font-bold mb-3">Nid de guêpes à Bruxelles ?</h2>
