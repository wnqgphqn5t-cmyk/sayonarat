...
export const metadata: Metadata = {
  alternates: { canonical: "/mites-alimentaires-beyne-heusay" },
  title: "Mites alimentaires Beyne-Heusay — Traitement professionnel",
  description:
    "Mites alimentaires à Beyne-Heusay ? Traitement professionnel contre les mites des denrées. Intervention sous 48h, devis gratuit. Garantie de réintervention.",
};

const jsonLd = {
  "@context": "https://schema.org",
  "@type": "Service",
  name: "Traitement mites alimentaires à Beyne-Heusay",
  provider: {
    "@type": "LocalBusiness",
    name: "Sayonarat",
    telephone: phone,
  ...
  description: "Service de traitement contre les mites alimentaires à Beyne-Heusay. Intervention rapide, produits homologués.",
  serviceType: "PestControl",
};

const faqs = [
  {
    q: "Comment savoir si j'ai des mites alimentaires à Beyne-Heusay ?",
  ...
  {
    q: "Comment les mites alimentaires arrivent-elles dans un logement à Beyne-Heusay ?",
    a: "Principalement via des produits alimentaires secs achetés en grande surface. Les cuisines des maisons de Beyne et Heusay, souvent avec de grands placards, peuvent abriter une infestation pendant plusieurs semaines sans signe visible.",
  },
  {
  ...
  {
    q: "Combien coûte un traitement mites alimentaires à Beyne-Heusay ?",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Beyne-Heusay", item: "https://www.sayonarat.be/mites-alimentaires-beyne-heusay" },
  ],
};

export default function MitesAlimentairesBeyneHeusayPage() {
  return (
    <>
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="text-white py-14 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-3xl md:text-4xl font-bold mb-4">
            Mites alimentaires à Beyne-Heusay — Traitement professionnel
          </h1>
          <p className="text-green-100 text-lg max-w-2xl mb-6">
            Larves dans la farine, papillons dans les placards ? Sayonarat intervient pour
            éliminer les mites des denrées à Beyne-Heusay. Devis gratuit sous 24h.
          </p>
      ...
      <section className="py-14 px-4 max-w-4xl mx-auto">
        <h2 className="text-2xl font-bold mb-4" style={{ color: "#1B4332" }}>
          Mites alimentaires à Beyne-Heusay
        </h2>
        <p className="text-gray-700 mb-4 leading-relaxed">
          Les logements familiaux de Beyne, Heusay et Queue-du-Bois sont régulièrement touchés par les mites alimentaires importées via des achats en grande surface. Les cuisines avec des placards peu inspectés sont les zones à risque.
        </p>
        ...
        <div className="p-6 rounded-2xl text-white text-center" style={{ backgroundColor: "#1B4332" }}>
          <h2 className="text-xl font-bold mb-2">Des mites alimentaires à Beyne-Heusay ?</h2>
        ...
        <div className="mt-10 pt-6 border-t border-gray-100">
          ...
          <div className="flex flex-wrap gap-3 text-sm">
            ...
            <Link href="/mites-alimentaires-verviers" className="underline" style={{ color: "#1B4332" }}>Mites alimentaires Verviers</Link>
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="py-14 px-4 text-white text-center">
        <h2 className="text-2xl font-bold mb-3">Mites alimentaires à Beyne-Heusay ?</h2>
