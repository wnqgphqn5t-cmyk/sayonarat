...
export const metadata: Metadata = {
  alternates: { canonical: "/cafards-beyne-heusay" },
  title: "Cafards Beyne-Heusay — Élimination garantie, intervention rapide",
  description:
    "Infestation de cafards à Beyne-Heusay ? Traitement professionnel par gel insecticide ou pulvérisation. Résultat garanti, devis gratuit sous 24h. Techniciens professionnels.",
};
...
const faqs = [
  {
    q: "Comment savoir si j'ai des cafards dans mon logement à Beyne-Heusay ?",
  ...
  {
    q: "Pourquoi les cafards se propagent-ils à Beyne-Heusay ?",
    a: "L'humidité de la vallée de Beyne-Heusay favorise les blattes orientales dans les sous-sols. Les maisons mitoyennes de Beyne-centre partagent des fondations communes qui permettent aux cafards de circuler entre logements voisins.",
  },
  {
    q: "Combien coûte un traitement cafards à Beyne-Heusay ?",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Élimination cafards à Beyne-Heusay",
  provider: {
    "@type": "LocalBusiness",
    name: "Sayonarat",
    telephone: phone,
  ...
  description: "Service professionnel d'élimination de cafards à Beyne-Heusay. Traitement par gel insecticide, résultat garanti.",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Beyne-Heusay", item: "https://www.sayonarat.be/cafards-beyne-heusay" },
  ],
};

export default function CafardsBeyneHeusayPage() {
  return (
    <>
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="text-white py-14 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-3xl md:text-4xl font-bold mb-4">
            Cafards à Beyne-Heusay — Élimination garantie | Sayonarat
          </h1>
          <p className="text-green-100 text-lg max-w-2xl mb-6">
            Une infestation de cafards s'étend vite et ne disparaît pas seule.
            Sayonarat vous met en contact avec un technicien professionnel à Beyne-Heusay,
      ...
      <section className="py-14 px-4 max-w-4xl mx-auto">
        <div className="relative rounded-2xl overflow-hidden shadow-lg h-64 md:h-80 mb-10">
          <Image
            ...
            alt={"Traitement cafards à Beyne-Heusay"}
            fill
            className="object-cover"
            priority
          />
          <div className="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent flex items-end p-5">
            <p className="text-white text-sm font-medium">Traitement professionnel cafards — Beyne-Heusay</p>
          </div>
        </div>

        <h2 className="text-2xl font-bold mb-4" style={{ color: "#1B4332" }}>
          Cafards à Beyne-Heusay : pourquoi agir vite ?
        </h2>
        <p className="text-gray-700 mb-6 leading-relaxed">
          Les immeubles collectifs de Queue-du-Bois et les maisons mitoyennes anciennes de Beyne-centre partagent des gaines communes propices à la propagation des blattes. L'humidité caractéristique de la vallée favorise également l'installation des blattes orientales dans les sous-sols.
        </p>
        <p className="text-gray-700 mb-6 leading-relaxed">
        ...
        <div className="bg-yellow-50 border-l-4 border-yellow-400 p-5 rounded-r-xl mb-8">
          <p className="font-semibold text-gray-800 mb-3">Tarifs indicatifs — Cafards Beyne-Heusay</p>
      ...
      <section className="py-12 px-4 bg-gray-50">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-2xl font-bold mb-8 text-center" style={{ color: "#1B4332" }}>
            Questions fréquentes — Cafards Beyne-Heusay
          </h2>
      ...
      <section className="py-10 px-4 max-w-4xl mx-auto">
        ...
        <div className="flex flex-wrap gap-3 text-sm">
          {[
            ...
            { label: "Cafards Verviers", href: "/cafards-verviers" },
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="py-14 px-4 text-white text-center">
        <h2 className="text-2xl font-bold mb-3">Cafards à Beyne-Heusay ? Agissez maintenant.</h2>
