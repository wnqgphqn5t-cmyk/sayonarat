...
export const metadata: Metadata = {
  alternates: { canonical: "/mites-alimentaires-awans" },
  title: "Mites alimentaires Awans — Traitement professionnel",
  description:
    "Mites alimentaires à Awans ? Traitement professionnel contre les mites des denrées. Intervention sous 48h, devis gratuit. Garantie de réintervention.",
};

const jsonLd = {
  "@context": "https://schema.org",
  "@type": "Service",
  name: "Traitement mites alimentaires à Awans",
  provider: {
    "@type": "LocalBusiness",
    name: "Sayonarat",
    telephone: phone,
  ...
  areaServed: "Awans",
  description: "Service de traitement contre les mites alimentaires à Awans. Intervention rapide, produits homologués.",
  serviceType: "PestControl",
};

const faqs = [
  {
    q: "Comment savoir si j'ai des mites alimentaires à Awans ?",
  ...
  {
    q: "Comment les mites alimentaires arrivent-elles dans un logement à Awans ?",
    a: "Dans les maisons rurales d'Awans, via des réserves de farine, céréales ou fruits secs stockés en cave ou grenier, souvent peu contrôlées. Les grandes propriétés avec garde-manger sont les plus exposées à des infestations qui peuvent passer inaperçues pendant des semaines.",
  },
  {
  ...
  {
    q: "Combien coûte un traitement mites alimentaires à Awans ?",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Awans", item: "https://www.sayonarat.be/mites-alimentaires-awans" },
  ],
};

export default function MitesAlimentairesAwansPage() {
  return (
    <>
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="text-white py-14 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-3xl md:text-4xl font-bold mb-4">
            Mites alimentaires à Awans — Traitement professionnel
          </h1>
          <p className="text-green-100 text-lg max-w-2xl mb-6">
            Larves dans la farine, papillons dans les placards ? Sayonarat intervient pour
            éliminer les mites des denrées à Awans. Devis gratuit sous 24h.
          </p>
      ...
      <section className="py-14 px-4 max-w-4xl mx-auto">
        <h2 className="text-2xl font-bold mb-4" style={{ color: "#1B4332" }}>
          Mites alimentaires à Awans
        </h2>
        <p className="text-gray-700 mb-4 leading-relaxed">
          Les maisons rurales d'Awans avec leurs importantes réserves alimentaires en cave ou grenier sont particulièrement vulnérables. Les grandes propriétés avec garde-manger ou réserves de céréales sont les plus exposées aux infestations persistantes.
        </p>
        ...
        <div className="p-6 rounded-2xl text-white text-center" style={{ backgroundColor: "#1B4332" }}>
          <h2 className="text-xl font-bold mb-2">Des mites alimentaires à Awans ?</h2>
        ...
        <div className="mt-10 pt-6 border-t border-gray-100">
          ...
          <div className="flex flex-wrap gap-3 text-sm">
            ...
            <Link href="/mites-alimentaires-oupeye" className="underline" style={{ color: "#1B4332" }}>Mites alimentaires Oupeye</Link>
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="py-14 px-4 text-white text-center">
        <h2 className="text-2xl font-bold mb-3">Mites alimentaires à Awans ?</h2>
