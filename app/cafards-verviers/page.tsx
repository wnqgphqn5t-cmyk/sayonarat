...
export const metadata: Metadata = {
  alternates: { canonical: "/cafards-verviers" },
  title: "Cafards Verviers — Élimination garantie, intervention rapide",
  description:
    "Infestation de cafards à Verviers ? Traitement professionnel par gel insecticide ou pulvérisation. Résultat garanti, devis gratuit sous 24h. Techniciens professionnels.",
};
...
const faqs = [
  {
    q: "Comment savoir si j'ai des cafards dans mon logement à Verviers ?",
  ...
  {
    q: "Pourquoi les cafards se propagent-ils à Verviers ?",
    a: "L'humidité de la vallée de la Vesdre fait de Verviers un terrain favorable aux blattes orientales, qui préfèrent les zones humides. Les sous-sols des maisons mitoyennes d'Ensival et Dison sont souvent très humides et constituent des refuges idéaux pour les cafards.",
  },
  {
    q: "Combien coûte un traitement cafards à Verviers ?",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Élimination cafards à Verviers",
  provider: {
    "@type": "LocalBusiness",
    name: "Sayonarat",
    telephone: phone,
  ...
  areaServed: "Verviers",
  description: "Service professionnel d'élimination de cafards à Verviers. Traitement par gel insecticide, résultat garanti.",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Verviers", item: "https://www.sayonarat.be/cafards-verviers" },
  ],
};

export default function CafardsVerviersPage() {
  return (
    <>
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="text-white py-14 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-3xl md:text-4xl font-bold mb-4">
            Cafards à Verviers — Élimination garantie | Sayonarat
          </h1>
          <p className="text-green-100 text-lg max-w-2xl mb-6">
            Une infestation de cafards s'étend vite et ne disparaît pas seule.
            Sayonarat vous met en contact avec un technicien professionnel à Verviers,
      ...
      <section className="py-14 px-4 max-w-4xl mx-auto">
        <div className="relative rounded-2xl overflow-hidden shadow-lg h-64 md:h-80 mb-10">
          <Image
            ...
            alt={"Traitement cafards à Verviers"}
            fill
            className="object-cover"
            priority
          />
          <div className="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent flex items-end p-5">
            <p className="text-white text-sm font-medium">Traitement professionnel cafards — Verviers</p>
          </div>
        </div>

        <h2 className="text-2xl font-bold mb-4" style={{ color: "#1B4332" }}>
          Cafards à Verviers : pourquoi agir vite ?
        </h2>
        <p className="text-gray-700 mb-6 leading-relaxed">
          L'humidité caractéristique de la vallée de la Vesdre et les immeubles anciens du centre de Verviers créent des conditions très favorables aux cafards, en particulier aux blattes orientales. Les maisons mitoyennes d'Ensival et Dison avec leurs sous-sols souvent humides sont particulièrement exposées.
        </p>
        <p className="text-gray-700 mb-6 leading-relaxed">
        ...
        <div className="bg-yellow-50 border-l-4 border-yellow-400 p-5 rounded-r-xl mb-8">
          <p className="font-semibold text-gray-800 mb-3">Tarifs indicatifs — Cafards Verviers</p>
      ...
      <section className="py-12 px-4 bg-gray-50">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-2xl font-bold mb-8 text-center" style={{ color: "#1B4332" }}>
            Questions fréquentes — Cafards Verviers
          </h2>
      ...
      <section className="py-10 px-4 max-w-4xl mx-auto">
        ...
        <div className="flex flex-wrap gap-3 text-sm">
          {[
            ...
            { label: "Cafards Beyne-Heusay", href: "/cafards-beyne-heusay" },
            { label: "Cafards Seraing", href: "/cafards-seraing" },
            { label: "Cafards Namur", href: "/cafards-namur" }
          ].map((l) => (
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="py-14 px-4 text-white text-center">
        <h2 className="text-2xl font-bold mb-3">Cafards à Verviers ? Agissez maintenant.</h2>
