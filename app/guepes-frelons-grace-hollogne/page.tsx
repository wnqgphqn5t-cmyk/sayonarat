...
export const metadata: Metadata = {
  alternates: { canonical: "/guepes-frelons-grace-hollogne" },
  title: "Guêpes et frelons Grâce-Hollogne — Destruction nid rapide",
  description:
    "Nid de guêpes ou frelons à Grâce-Hollogne ? Destruction professionnelle sous 48h. Intervention nocturne sécurisée, garantie résultat. Devis gratuit.",
};

const faqs = [
  {
    q: "Combien coûte la destruction d'un nid de guêpes à Grâce-Hollogne ?",
  ...
  {
    q: "Les guêpes à Grâce-Hollogne : quelles zones sont les plus touchées ?",
    a: "Les jardins pavillonnaires de Grace et Hollogne sont particulièrement touchés, avec des nids fréquents dans les haies, les combles et sous les auvents. La période critique est juillet–septembre. Le frelon asiatique est également présent dans la commune.",
  },
  {
    q: "Mon voisin a un nid de guêpes à Grâce-Hollogne, que faire ?",
  ...
  {
    q: "Le frelon asiatique est-il présent à Grâce-Hollogne ?",
    a: "Oui. Le frelon asiatique est désormais établi dans toute la Belgique, y compris à Grâce-Hollogne. Son nid, souvent perché à plus de 5 mètres de hauteur dans les arbres, est plus difficile à traiter qu'un nid de guêpes classique. Une intervention professionnelle avec équipement adapté est indispensable.",
  },
];
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Destruction nid guêpes et frelons à Grâce-Hollogne",
  provider: {
    "@type": "LocalBusiness",
    name: "Sayonarat",
    telephone: phone,
  ...
  description: "Service de destruction de nids de guêpes et frelons à Grâce-Hollogne. Intervention nocturne sécurisée, résultat garanti.",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "Désinsectisation Grâce-Hollogne", item: "https://www.sayonarat.be/desinsectisation-grace-hollogne" },
    { "@type": "ListItem", position: 3, name: "Grâce-Hollogne", item: "https://www.sayonarat.be/guepes-frelons-grace-hollogne" },
  ],
};

export default function GuepesFretonsGraceHollognePage() {
  return (
    <>
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="text-white py-14 px-4">
        <div className="max-w-4xl mx-auto">
          <p className="text-green-300 text-sm mb-2">
            ...
            <Link href="/desinsectisation-grace-hollogne" className="hover:text-white">Désinsectisation Grâce-Hollogne</Link> ›{" "}
            Grâce-Hollogne
          </p>
          <h1 className="text-3xl md:text-4xl font-bold mb-4">
            Guêpes et frelons à Grâce-Hollogne — Destruction nid | Sayonarat
          </h1>
          <p className="text-green-100 text-lg max-w-2xl mb-6">
            Nid de guêpes dans vos combles ou jardin à Grâce-Hollogne ? Intervention nocturne
      ...
      <section className="py-14 px-4 max-w-4xl mx-auto">
        <div className="relative rounded-2xl overflow-hidden shadow-lg h-64 md:h-72 mb-10">
          <Image src="/nid-guepes.jpg" alt={"Nid de guêpes traité à Grâce-Hollogne"} fill className="object-cover" priority />
          <div className="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent flex items-end p-5">
            <p className="text-white text-sm font-medium">Destruction de nid de guêpes — Grâce-Hollogne</p>
          </div>
        </div>
        ...
        <h2 className="text-2xl font-bold mb-4" style={{ color: "#1B4332" }}>Nids de guêpes à Grâce-Hollogne : une commune résidentielle de la banlieue ouest de Liège avec ses cités pavillonnaires des années 60–80. Les jardins des pavillons de Grace et Hollogne-aux-Pierres, les toitures et les zones boisées en bordure de commune concentrent la majorité des nids signalés.</h2>
        <p className="text-gray-700 mb-8 leading-relaxed">
          ...
          Grace et Hollogne-aux-Pierres concentrent la plupart des nids signalés, dans les combles des pavillons et les haies de jardins. Bierset, en zone plus rurale, présente des nids dans les haies et les arbres.
        </p>
      ...
      <section className="py-12 px-4 bg-gray-50">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-2xl font-bold mb-8 text-center" style={{ color: "#1B4332" }}>Questions fréquentes — Guêpes Grâce-Hollogne</h2>
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="py-14 px-4 text-white text-center">
        <h2 className="text-2xl font-bold mb-3">Nid de guêpes à Grâce-Hollogne ?</h2>
