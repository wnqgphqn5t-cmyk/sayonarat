...
const faqs = [
  {
    q: "Comment savoir si j'ai des cafards dans mon logement à Grâce-Hollogne ?",
  ...
  {
    q: "Pourquoi les cafards se propagent-ils à Grâce-Hollogne ?",
    a: "Les cités des années 60–80 de Grace et Hollogne présentent des gaines et vide-sanitaires qui permettent aux cafards de se déplacer entre maisons mitoyennes. Un traitement individuel est souvent insuffisant — il faut traiter l'ensemble de la rangée de maisons.",
  },
  {
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Élimination cafards à Grâce-Hollogne",
  provider: {
    "@type": "LocalBusiness",
    name: "Sayonarat",
  ...
  description: "Service professionnel d'élimination de cafards à Grâce-Hollogne. Traitement par gel insecticide, résultat garanti.",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Grâce-Hollogne", item: "https://www.sayonarat.be/cafards-grace-hollogne" },
  ],
};

export default function CafardsGraceHollognePage() {
  return (
    <>
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="text-white py-14 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-3xl md:text-4xl font-bold mb-4">
            Cafards à Grâce-Hollogne — Élimination garantie | Sayonarat
          </h1>
      ...
      <section className="py-14 px-4 max-w-4xl mx-auto">
        <div className="relative rounded-2xl overflow-hidden shadow-lg h-64 md:h-80 mb-10">
          <Image
            ...
            alt={"Traitement cafards à Grâce-Hollogne"}
            fill
            className="object-cover"
            priority
          />
          <div className="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent flex items-end p-5">
            <p className="text-white text-sm font-medium">Traitement professionnel cafards — Grâce-Hollogne</p>
          </div>
        </div>

        <h2 className="text-2xl font-bold mb-4" style={{ color: "#1B4332" }}>
          Cafards à Grâce-Hollogne : pourquoi agir vite ?
        </h2>
        <p className="text-gray-700 mb-6 leading-relaxed">
          Les cités résidentielles des années 60–80 de Grace et Hollogne-aux-Pierres comportent des gaines et des vide-sanitaires qui facilitent les déplacements des blattes entre habitations. Les logements collectifs de la commune sont les plus exposés aux infestations persistantes.
        </p>
        <p className="text-gray-700 mb-6 leading-relaxed">
      ...
      <section className="py-12 px-4 bg-gray-50">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-2xl font-bold mb-8 text-center" style={{ color: "#1B4332" }}>
            Questions fréquentes — Cafards Grâce-Hollogne
          </h2>
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="py-14 px-4 text-white text-center">
        <h2 className="text-2xl font-bold mb-3">Cafards à Grâce-Hollogne ? Agissez maintenant.</h2>
