...
export const metadata: Metadata = {
  alternates: { canonical: "/mites-alimentaires-oupeye" },
  title: "Mites alimentaires Oupeye — Traitement professionnel",
  description:
    "Mites alimentaires à Oupeye ? Traitement professionnel contre les mites des denrées. Intervention sous 48h, devis gratuit. Garantie de réintervention.",
};

const jsonLd = {
  "@context": "https://schema.org",
  "@type": "Service",
  name: "Traitement mites alimentaires à Oupeye",
  provider: {
    "@type": "LocalBusiness",
    name: "Sayonarat",
    telephone: phone,
  ...
  areaServed: "Oupeye",
  description: "Service de traitement contre les mites alimentaires à Oupeye. Intervention rapide, produits homologués.",
  serviceType: "PestControl",
};

const faqs = [
  {
    q: "Comment savoir si j'ai des mites alimentaires à Oupeye ?",
  ...
  {
    q: "Comment les mites alimentaires arrivent-elles dans un logement à Oupeye ?",
    a: "L'humidité des caves des maisons ouvrières d'Oupeye crée des conditions favorables. Via des produits alimentaires secs stockés en sous-sol dans des emballages non hermétiques — les réserves en cave sont les plus exposées.",
  },
  {
  ...
  {
    q: "Combien coûte un traitement mites alimentaires à Oupeye ?",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Oupeye", item: "https://www.sayonarat.be/mites-alimentaires-oupeye" },
  ],
};

export default function MitesAlimentairesOupeyePage() {
  return (
    <>
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="text-white py-14 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-3xl md:text-4xl font-bold mb-4">
            Mites alimentaires à Oupeye — Traitement professionnel
          </h1>
          <p className="text-green-100 text-lg max-w-2xl mb-6">
            Larves dans la farine, papillons dans les placards ? Sayonarat intervient pour
            éliminer les mites des denrées à Oupeye. Devis gratuit sous 24h.
          </p>
      ...
      <section className="py-14 px-4 max-w-4xl mx-auto">
        <h2 className="text-2xl font-bold mb-4" style={{ color: "#1B4332" }}>
          Mites alimentaires à Oupeye
        </h2>
        <p className="text-gray-700 mb-4 leading-relaxed">
          Les maisons anciennes d'Hermalle et de Haccourt avec leurs caves et provisions en sous-sol sont exposées aux mites alimentaires. L'humidité des zones en bord de Meuse favorise l'éclosion et la multiplication rapide des larves.
        </p>
        ...
        <div className="p-6 rounded-2xl text-white text-center" style={{ backgroundColor: "#1B4332" }}>
          <h2 className="text-xl font-bold mb-2">Des mites alimentaires à Oupeye ?</h2>
        ...
        <div className="mt-10 pt-6 border-t border-gray-100">
          ...
          <div className="flex flex-wrap gap-3 text-sm">
            ...
            <Link href="/mites-alimentaires-herstal" className="underline" style={{ color: "#1B4332" }}>Mites alimentaires Herstal</Link>
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="py-14 px-4 text-white text-center">
        <h2 className="text-2xl font-bold mb-3">Mites alimentaires à Oupeye ?</h2>
