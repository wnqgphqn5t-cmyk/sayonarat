...
export const metadata: Metadata = {
  alternates: { canonical: "/mites-alimentaires-seraing" },
  title: "Mites alimentaires Seraing — Traitement professionnel",
  description:
    "Mites alimentaires à Seraing ? Traitement professionnel contre les mites des denrées. Intervention sous 48h, devis gratuit. Garantie de réintervention.",
};

const jsonLd = {
  "@context": "https://schema.org",
  "@type": "Service",
  name: "Traitement mites alimentaires à Seraing",
  provider: {
    "@type": "LocalBusiness",
    name: "Sayonarat",
    telephone: phone,
  ...
  areaServed: "Seraing",
  description: "Service de traitement contre les mites alimentaires à Seraing. Intervention rapide, produits homologués.",
  serviceType: "PestControl",
};

const faqs = [
  {
    q: "Comment savoir si j'ai des mites alimentaires à Seraing ?",
  ...
  {
    q: "Comment les mites alimentaires arrivent-elles dans un logement à Seraing ?",
    a: "L'humidité des caves des maisons ouvrières de Seraing crée des conditions idéales pour la prolifération des larves. Via des produits alimentaires secs stockés dans des emballages non hermétiques en sous-sol — les réserves des maisons ouvrières sont les zones les plus exposées.",
  },
  {
  ...
  {
    q: "Combien coûte un traitement mites alimentaires à Seraing ?",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Seraing", item: "https://www.sayonarat.be/mites-alimentaires-seraing" },
  ],
};

export default function MitesAlimentairesSeraingPage() {
  return (
    <>
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="text-white py-14 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-3xl md:text-4xl font-bold mb-4">
            Mites alimentaires à Seraing — Traitement professionnel
          </h1>
          <p className="text-green-100 text-lg max-w-2xl mb-6">
            Larves dans la farine, papillons dans les placards ? Sayonarat intervient pour
            éliminer les mites des denrées à Seraing. Devis gratuit sous 24h.
          </p>
      ...
      <section className="py-14 px-4 max-w-4xl mx-auto">
        <h2 className="text-2xl font-bold mb-4" style={{ color: "#1B4332" }}>
          Mites alimentaires à Seraing
        </h2>
        <p className="text-gray-700 mb-4 leading-relaxed">
          Les caves humides et les garde-manger des maisons ouvrières de Seraing créent des conditions favorables aux mites alimentaires. Jemeppe-sur-Meuse et Ougrée sont les secteurs les plus touchés, notamment dans les logements les plus anciens.
        </p>
        ...
        <div className="p-6 rounded-2xl text-white text-center" style={{ backgroundColor: "#1B4332" }}>
          <h2 className="text-xl font-bold mb-2">Des mites alimentaires à Seraing ?</h2>
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="py-14 px-4 text-white text-center">
        <h2 className="text-2xl font-bold mb-3">Mites alimentaires à Seraing ?</h2>
