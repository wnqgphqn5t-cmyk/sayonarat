...
const faqs = [
  {
    q: "Comment les punaises de lit arrivent-elles à Verviers ?",
    a: "Principalement via les voyages (valises contaminées), les achats de meubles ou matelas d'occasion dans les brocantes de la région verviétoise, et les déménagements depuis des logements infestés. Les anciens bâtiments textiles reconvertis en logements peuvent également abriter des infestations historiques non traitées.",
  },
  {
    q: "Combien coûte un traitement punaises de lit à Verviers ?",
  ...
  {
    q: "Le traitement thermique est-il adapté aux anciens bâtiments textiles de Verviers ?",
    a: "Oui, dans la grande majorité des cas. Les anciens bâtiments industriels reconvertis en logements à Verviers nécessitent parfois une évaluation préalable des conditions thermiques. Certains objets sensibles à la chaleur doivent être retirés avant l'intervention. Le technicien vous fournit une liste précise lors du diagnostic.",
  },
  {
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Traitement punaises de lit à Verviers",
  provider: {
    "@type": "LocalBusiness",
    name: "Sayonarat",
    telephone: phone,
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Verviers", item: "https://www.sayonarat.be/punaises-de-lit-verviers" },
  ],
};

export default function PunaisesVerviersPage() {
  return (
    <>
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="text-white py-14 px-4">
        <div className="max-w-4xl mx-auto">
          <p className="text-green-300 text-sm mb-2">
            ...
            <Link href="/punaises-de-lit-liege" className="hover:text-white">Punaises de lit Liège</Link> › Verviers
          </p>
          <h1 className="text-3xl md:text-4xl font-bold mb-4">
            Punaises de lit Verviers — Traitement garanti | Sayonarat
          </h1>
          <p className="text-green-100 text-lg max-w-2xl mb-6">
            Punaises de lit à Verviers ? Traitement thermique ou chimique dans la vallée de la Vesdre
            et tous les quartiers. Résultat garanti dès la première intervention. Devis gratuit sous 24h.
          </p>
      ...
      <section className="py-14 px-4 max-w-4xl mx-auto">
        <div className="relative rounded-2xl overflow-hidden shadow-lg h-64 mb-10">
          <Image src="/chambre-punaises.jpg" alt="Chambre traitée punaises de lit Verviers" fill className="object-cover" priority />
          <div className="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent flex items-end p-5">
            <p className="text-white text-sm font-medium">Chambre saine après traitement punaises — Verviers</p>
          </div>
        </div>

        <h2 className="text-2xl font-bold mb-6" style={{ color: "#1B4332" }}>Deux méthodes de traitement à Verviers</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
          <div className="border-2 border-green-200 rounded-xl p-6">
            ...
            <p className="text-sm text-gray-600 mb-3">Chaleur portée à 60°C+ pendant 6 à 8h. Détruit punaises et œufs en une seule session, sans produit chimique résiduel. Idéal pour les logements dans les anciens bâtiments textiles verviétois reconvertis.</p>
      ...
      <section className="py-12 px-4 bg-gray-50">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-2xl font-bold mb-8 text-center" style={{ color: "#1B4332" }}>Questions fréquentes — Punaises de lit Verviers</h2>
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="py-14 px-4 text-white text-center">
        <h2 className="text-2xl font-bold mb-3">Punaises de lit à Verviers ?</h2>
