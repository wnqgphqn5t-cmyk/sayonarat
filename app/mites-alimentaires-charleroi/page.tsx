...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Traitement mites alimentaires à Charleroi",
  provider: {
    "@type": "LocalBusiness",
    name: "Sayonarat",
  ...
  description: "Service de traitement contre les mites alimentaires à Charleroi. Intervention rapide, produits homologués.",
  serviceType: "PestControl",
};

const faqs = [
  {
    q: "Comment savoir si j'ai des mites alimentaires à Charleroi ?",
  ...
  {
    q: "Comment les mites alimentaires arrivent-elles dans un logement à Charleroi ?",
    a: "Via des produits alimentaires secs achetés dans les nombreux commerces du centre de Charleroi. Les caves humides des maisons du bassin industriel sont des incubateurs idéaux pour les larves de mites une fois l'infestation démarrée.",
  },
  {
  ...
  {
    q: "Combien coûte un traitement mites alimentaires à Charleroi ?",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Charleroi", item: "https://www.sayonarat.be/mites-alimentaires-charleroi" },
  ],
};

export default function MitesAlimentairesCharleroiPage() {
  return (
    <>
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="text-white py-14 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-3xl md:text-4xl font-bold mb-4">
            Mites alimentaires à Charleroi — Traitement professionnel
          </h1>
          <p className="text-green-100 text-lg max-w-2xl mb-6">
            Larves dans la farine, papillons dans les placards ? Sayonarat intervient pour
            éliminer les mites des denrées à Charleroi. Devis gratuit sous 24h.
          </p>
      ...
      <section className="py-14 px-4 max-w-4xl mx-auto">
        <h2 className="text-2xl font-bold mb-4" style={{ color: "#1B4332" }}>
          Mites alimentaires à Charleroi
        </h2>
        <p className="text-gray-700 mb-4 leading-relaxed">
          Les caves et garde-manger des maisons anciennes de Charleroi, souvent humides, favorisent l'éclosion et la prolifération des larves de mites alimentaires. Les logements du centre-ville et de Gilly sont régulièrement concernés.
        </p>
        ...
        <div className="p-6 rounded-2xl text-white text-center" style={{ backgroundColor: "#1B4332" }}>
          <h2 className="text-xl font-bold mb-2">Des mites alimentaires à Charleroi ?</h2>
