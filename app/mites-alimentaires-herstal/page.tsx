...
export const metadata: Metadata = {
  ...
  description:
    "Mites alimentaires à Herstal ? Traitement professionnel contre les mites des denrées. Intervention sous 48h, devis gratuit. Garantie de réintervention.",
};

const jsonLd = {
  "@context": "https://schema.org",
  "@type": "Service",
  name: "Traitement mites alimentaires à Herstal",
  provider: {
    "@type": "LocalBusiness",
    name: "Sayonarat",
    telephone: phone,
  ...
  areaServed: "Herstal",
  description: "Service de traitement contre les mites alimentaires à Herstal. Intervention rapide, produits homologués.",
  serviceType: "PestControl",
};

const faqs = [
  {
    q: "Comment savoir si j'ai des mites alimentaires à Herstal ?",
  ...
  {
    q: "Comment les mites alimentaires arrivent-elles dans un logement à Herstal ?",
    a: "Dans les appartements des cités de Herstal, via des produits secs mal conservés ou des aliments importés. Les cuisines compactes avec peu de rotation des stocks sont les plus vulnérables aux infestations de longue durée.",
  },
  {
  ...
  {
    q: "Combien coûte un traitement mites alimentaires à Herstal ?",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Herstal", item: "https://www.sayonarat.be/mites-alimentaires-herstal" },
  ],
};

export default function MitesAlimentairesHerstalPage() {
  return (
    <>
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="text-white py-14 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-3xl md:text-4xl font-bold mb-4">
            Mites alimentaires à Herstal — Traitement professionnel
          </h1>
      ...
      <section className="py-14 px-4 max-w-4xl mx-auto">
        <h2 className="text-2xl font-bold mb-4" style={{ color: "#1B4332" }}>
          Mites alimentaires à Herstal
        </h2>
        <p className="text-gray-700 mb-4 leading-relaxed">
          Les appartements des cités sociales de Herstal, avec leurs cuisines souvent compactes, sont exposés aux mites alimentaires. Vottem et Milmort concentrent la plupart des signalements, notamment dans les logements avec grandes réserves alimentaires.
        </p>
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="py-14 px-4 text-white text-center">
        <h2 className="text-2xl font-bold mb-3">Mites alimentaires à Herstal ?</h2>
