...
export const metadata: Metadata = {
  ...
  description:
    "Désinsectisation professionnelle à Charleroi. Cafards, fourmis, guêpes. Bassin industriel, quartiers résidentiels couverts. Devis gratuit sous 24h, garantie de réintervention.",
};
...
const faqs = [
  ...
  },
  {
    ...
    a: "Le tarif dépend de la superficie et du degré d'infestation. Pour les bâtiments industriels ou commerciaux du bassin carolorégien, tarif établi sur devis. Devis gratuit sous 24h.",
  },
  {
...
const jsonLd = {
  ...
  description: "Désinsectisation professionnelle à Charleroi. Cafards, fourmis, guêpes dans le bassin industriel et les quartiers résidentiels. Produits homologués, garantie de réintervention.",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Charleroi", item: "https://www.sayonarat.be/desinsectisation-charleroi" },
  ],
};
    ...
    <>
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="text-white py-14 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-green-100 text-lg max-w-2xl mb-6">
            ...
            Produits homologués, garantie de réintervention.
          </p>
      ...
      <section className="py-12 px-4 max-w-4xl mx-auto">
        <h2 className="text-2xl font-bold mb-5" style={{ color: "#1B4332" }}>
          Traitements spécialisés à Charleroi
        </h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-10">
          <Link href="/cafards-charleroi" className="border border-gray-200 rounded-xl p-5 hover:shadow-md hover:border-green-300 transition-all block">
            <h3 className="font-bold text-lg mb-2" style={{ color: "#1B4332" }}>Cafards à Charleroi →</h3>
          ...
          <Link href="/fourmis-charleroi" className="border border-gray-200 rounded-xl p-5 hover:shadow-md hover:border-green-300 transition-all block">
            <h3 className="font-bold text-lg mb-2" style={{ color: "#1B4332" }}>Fourmis à Charleroi →</h3>
            <p className="text-sm text-gray-600">Traitement adapté à l&apos;espèce : fourmis noires, pharaons, charpentières.</p>
          </Link>
          <Link href="/guepes-frelons-charleroi" className="border border-gray-200 rounded-xl p-5 hover:shadow-md hover:border-green-300 transition-all block">
            <h3 className="font-bold text-lg mb-2" style={{ color: "#1B4332" }}>Guêpes &amp; frelons à Charleroi →</h3>
            <p className="text-sm text-gray-600">Destruction de nid garantie sous 24h. Intervention sécurisée.</p>
          </Link>
          <Link href="/mites-alimentaires-charleroi" className="border border-gray-200 rounded-xl p-5 hover:shadow-md hover:border-green-300 transition-all block">
            <h3 className="font-bold text-lg mb-2" style={{ color: "#1B4332" }}>Mites alimentaires à Charleroi →</h3>
