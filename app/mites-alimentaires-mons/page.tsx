...
export const metadata: Metadata = {
  alternates: { canonical: "/mites-alimentaires-mons" },
  title: "Mites alimentaires Mons — Traitement professionnel",
  description:
    "Mites alimentaires à Mons ? Traitement professionnel contre les mites des denrées. Intervention sous 48h, devis gratuit. Garantie de réintervention.",
};

const jsonLd = {
  "@context": "https://schema.org",
  "@type": "Service",
  name: "Traitement mites alimentaires à Mons",
  provider: {
    "@type": "LocalBusiness",
    name: "Sayonarat",
    telephone: phone,
  ...
  areaServed: "Mons",
  description: "Service de traitement contre les mites alimentaires à Mons. Intervention rapide, produits homologués.",
  serviceType: "PestControl",
};

const faqs = [
  {
    q: "Comment savoir si j'ai des mites alimentaires à Mons ?",
  ...
  {
    q: "Comment les mites alimentaires arrivent-elles dans un logement à Mons ?",
    a: "À Mons, souvent via des denrées achetées dans les épiceries exotiques de la Grand-Place ou via des produits mal conservés. Les logements étudiants avec peu de rotation des stocks alimentaires sont les plus vulnérables.",
  },
  {
  ...
  {
    q: "Combien coûte un traitement mites alimentaires à Mons ?",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Mons", item: "https://www.sayonarat.be/mites-alimentaires-mons" },
  ],
};

export default function MitesAlimentairesMonsPage() {
  return (
    <>
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="text-white py-14 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-3xl md:text-4xl font-bold mb-4">
            Mites alimentaires à Mons — Traitement professionnel
          </h1>
          <p className="text-green-100 text-lg max-w-2xl mb-6">
            Larves dans la farine, papillons dans les placards ? Sayonarat intervient pour
            éliminer les mites des denrées à Mons. Devis gratuit sous 24h.
          </p>
      ...
      <section className="py-14 px-4 max-w-4xl mx-auto">
        <h2 className="text-2xl font-bold mb-4" style={{ color: "#1B4332" }}>
          Mites alimentaires à Mons
        </h2>
        <p className="text-gray-700 mb-4 leading-relaxed">
          Les cuisines des logements anciens du centre de Mons et les logements étudiants de la ville universitaire sont régulièrement touchés par les mites alimentaires. Les nombreux commerces alimentaires de la Grand-Place peuvent être des sources de contamination.
        </p>
        ...
        <div className="p-6 rounded-2xl text-white text-center" style={{ backgroundColor: "#1B4332" }}>
          <h2 className="text-xl font-bold mb-2">Des mites alimentaires à Mons ?</h2>
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="py-14 px-4 text-white text-center">
        <h2 className="text-2xl font-bold mb-3">Mites alimentaires à Mons ?</h2>
