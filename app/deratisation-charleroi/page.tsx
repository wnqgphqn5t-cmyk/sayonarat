...
export const metadata: Metadata = {
  ...
  description:
    "Dératisation professionnelle à Charleroi. Rats dans anciens sites industriels, sous-sols, bassin industriel. Devis gratuit sous 24h, garantie de réintervention.",
};
...
const faqs = [
  ...
  },
  {
    ...
    a: "Le tarif dépend de la superficie et du degré d'infestation. Devis gratuit sous 24h. Pour les sites industriels, entrepôts ou bâtiments commerciaux du bassin de Charleroi, tarif établi sur devis spécifique.",
  },
  {
...
const jsonLd = {
  ...
  description: "Service de dératisation professionnelle à Charleroi. Rats dans anciens sites industriels et quartiers résidentiels. Techniciens professionnels, garantie de réintervention.",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "Dératisation Liège", item: "https://www.sayonarat.be/deratisation-liege" },
    { "@type": "ListItem", position: 3, name: "Charleroi", item: "https://www.sayonarat.be/deratisation-charleroi" },
  ],
};
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="text-white py-14 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-green-100 text-lg max-w-2xl mb-6">
            ...
            anciens sites industriels, quartiers résidentiels. Techniciens professionnels, garantie de réintervention.
          </p>
      ...
      <section className="py-14 px-4 max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-10">
          {[
            ...
            { emoji: "🎯", t: "Traitement ciblé", d: "Appâts rodenticides autorisés (SPF), colmatage des accès, protection durable contre les réinfestations depuis les friches industrielles." },
