...
export const metadata: Metadata = {
  ...
  description:
    "Infestation de cafards à Herstal ? Traitement professionnel par gel insecticide ou pulvérisation. Résultat garanti, devis gratuit sous 24h. Techniciens professionnels.",
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Herstal", item: "https://www.sayonarat.be/cafards-herstal" },
  ],
};
      ...
      <section style={{ backgroundColor: "#1B4332" }} className="text-white py-14 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-green-100 text-lg max-w-2xl mb-6">
            ...
            Sayonarat vous met en contact avec un technicien professionnel à Herstal,
