...
const menu = [
  ...
  {
    categorie: "Punaises & Insectes",
    liens: [
      { label: "Punaises — Liège", href: "/punaises-de-lit-liege" },
      { label: "Punaises — Seraing", href: "/punaises-de-lit-seraing" },
      { label: "Punaises — Herstal", href: "/punaises-de-lit-herstal" },
      { label: "Désinsect. — Liège", href: "/desinsectisation-liege" },
      { label: "Désinsect. — Seraing", href: "/desinsectisation-seraing" },
      { label: "Désinsect. — Herstal", href: "/desinsectisation-herstal" },
      { label: "Toutes les villes →", href: "/desinsectisation-liege#communes" },
    ],
  },
  {
